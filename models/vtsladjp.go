...
type Vtsladjp struct {
	FCADJBY    string `gorm:"column:FCADJBY;" json:"fcadjby"  form:"fcadjby" `
	FCADJSTR   string `gorm:"column:FCADJSTR;" json:"fcadjstr"  form:"fcadjstr" `
	...
	FNNEWPRICE string `gorm:"column:FNNEWPRICE;" json:"fnnewprice"  form:"fnnewprice" `
	FNOLDPRICE string `gorm:"column:FNOLDPRICE;" json:"fnoldprice"  form:"fnoldprice" `
	...
	FTADJDATE  string `gorm:"column:FTADJDATE;" json:"ftadjdate"  form:"ftadjdate" `
...
func (Vtsladjp) TableName() string {
	return "VTSLADJP"
}

func (obj *Vtsladjp) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
