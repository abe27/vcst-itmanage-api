...
type Vtkmpds struct {
	...
	FCCHKEMPL  string    `gorm:"column:FCCHKEMPL;" json:"fcchkempl"  form:"fcchkempl" `
	...
	FCISPASS   string    `gorm:"column:FCISPASS;" json:"fcispass"  form:"fcispass" `
	FCLID      string    `gorm:"column:FCLID;" json:"fclid"  form:"fclid" `
	FCLUPDAPP  string    `gorm:"column:FCLUPDAPP;" json:"fclupdapp"  form:"fclupdapp" `
	FCORGCODE  string    `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
	FCPDSTYPE  string    `gorm:"column:FCPDSTYPE;" json:"fcpdstype"  form:"fcpdstype" `
	FCPROBLEM  string    `gorm:"column:FCPROBLEM;" json:"fcproblem"  form:"fcproblem" `
	FCSELTAG   string    `gorm:"column:FCSELTAG;" json:"fcseltag"  form:"fcseltag" `
	FCSEQ      string    `gorm:"column:FCSEQ;" json:"fcseq"  form:"fcseq" `
	FCSKID     string    `gorm:"primaryKey;column:FCSKID;size:8;unique;index;" json:"fcskid"  form:"fcskid" `
	FCSOLUTION string    `gorm:"column:FCSOLUTION;" json:"fcsolution"  form:"fcsolution" `
	...
	FDCHECK    string    `gorm:"column:FDCHECK;" json:"fdcheck"  form:"fdcheck" `
...
func (Vtkmpds) TableName() string {
	return "VTKMPDS"
}

func (obj *Vtkmpds) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
