...
type Sdrefh struct {
	...
	FCQCPLANT  string    `gorm:"column:FCQCPLANT;" json:"fcqcplant"  form:"fcqcplant" `
	FCSDCODE   string    `gorm:"column:FCSDCODE;" json:"fcsdcode"  form:"fcsdcode" `
	FCSDQCMBK  string    `gorm:"column:FCSDQCMBK;" json:"fcsdqcmbk"  form:"fcsdqcmbk" `
	FCSDREFNO  string    `gorm:"column:FCSDREFNO;" json:"fcsdrefno"  form:"fcsdrefno" `
	...
	FDSDDATE   string    `gorm:"column:FDSDDATE;" json:"fdsddate"  form:"fdsddate" `
...
func (Sdrefh) TableName() string {
	return "SDREFH"
}

func (obj *Sdrefh) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
