...
type Contprod struct{
     ...
     FCCRMCONTI string `gorm:"column:FCCRMCONTI;" json:"fccrmconti"  form:"fccrmconti" `
     ...
     FCISREPAIR string `gorm:"column:FCISREPAIR;" json:"fcisrepair"  form:"fcisrepair" `
...
func (Contprod) TableName() string{
return "CONTPROD"
}

func (obj *Contprod) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
