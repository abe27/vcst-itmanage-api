...
type Formiobj struct{
     ...
     FCNOTE string `gorm:"column:FCNOTE;" json:"fcnote"  form:"fcnote" `
     FCORGCODE string `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
     FCPICTURE string `gorm:"column:FCPICTURE;" json:"fcpicture"  form:"fcpicture" `
     FCREPIOBJ string `gorm:"column:FCREPIOBJ;" json:"fcrepiobj"  form:"fcrepiobj" `
     ...
     FCUSERDEFI string `gorm:"column:FCUSERDEFI;" json:"fcuserdefi"  form:"fcuserdefi" `
     ...
     FMCOMMENT string `gorm:"column:FMCOMMENT;" json:"fmcomment"  form:"fmcomment" `
     ...
     FMMSGHELP string `gorm:"column:FMMSGHELP;" json:"fmmsghelp"  form:"fmmsghelp" `
     FMMSGHELP2 string `gorm:"column:FMMSGHELP2;" json:"fmmsghelp2"  form:"fmmsghelp2" `
     FMREFTYPEL string `gorm:"column:FMREFTYPEL;" json:"fmreftypel"  form:"fmreftypel" `
     FMVALUE string `gorm:"column:FMVALUE;" json:"fmvalue"  form:"fmvalue" `
...
func (Formiobj) TableName() string{
return "FORMIOBJ"
}

func (obj *Formiobj) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
