...
type Prodx3 struct {
	...
	FCQCXCOOR  string `gorm:"column:FCQCXCOOR;" json:"fcqcxcoor"  form:"fcqcxcoor" `
	FCQCXPROD  string `gorm:"column:FCQCXPROD;" json:"fcqcxprod"  form:"fcqcxprod" `
...
func (Prodx3) TableName() string {
	return "PRODX3"
}

func (obj *Prodx3) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
