...
type Pdstwc struct {
	...
	FCFROPSEQ  string    `gorm:"column:FCFROPSEQ;" json:"fcfropseq"  form:"fcfropseq" `
	FCFRPDSTOP string    `gorm:"column:FCFRPDSTOP;" json:"fcfrpdstop"  form:"fcfrpdstop" `
	FCFRSUBOP  string    `gorm:"column:FCFRSUBOP;" json:"fcfrsubop"  form:"fcfrsubop" `
	...
	FCTOOPSEQ  string    `gorm:"column:FCTOOPSEQ;" json:"fctoopseq"  form:"fctoopseq" `
	FCTOPDSTOP string    `gorm:"column:FCTOPDSTOP;" json:"fctopdstop"  form:"fctopdstop" `
	FCTOSUBOP  string    `gorm:"column:FCTOSUBOP;" json:"fctosubop"  form:"fctosubop" `
	...
	FCWCGRP    string    `gorm:"column:FCWCGRP;" json:"fcwcgrp"  form:"fcwcgrp" `
	FCWKCTRH   string    `gorm:"column:FCWKCTRH;" json:"fcwkctrh"  form:"fcwkctrh" `
	FIMILLISEC string    `gorm:"column:FIMILLISEC;" json:"fimillisec"  form:"fimillisec" `
	FMEXTRATAG string    `gorm:"column:FMEXTRATAG;" json:"fmextratag"  form:"fmextratag" `
	FNDQTY     string    `gorm:"column:FNDQTY;" json:"fndqty"  form:"fndqty" `
	FNMQTY     string    `gorm:"column:FNMQTY;" json:"fnmqty"  form:"fnmqty" `
...
func (Pdstwc) TableName() string {
	return "PDSTWC"
}

func (obj *Pdstwc) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
