...
type Resolist struct {
	FBPICT     string `gorm:"column:FBPICT;" json:"fbpict"  form:"fbpict" `
...
func (Resolist) TableName() string {
	return "RESOLIST"
}

func (obj *Resolist) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
