...
type Boqmkup struct {
	...
	FCBOQI     string    `gorm:"column:FCBOQI;" json:"fcboqi"  form:"fcboqi" `
	...
	FCTXTKEY   string    `gorm:"column:FCTXTKEY;" json:"fctxtkey"  form:"fctxtkey" `
...
func (Boqmkup) TableName() string {
	return "BOQMKUP"
}

func (obj *Boqmkup) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
