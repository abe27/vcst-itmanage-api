...
type Vedipric struct {
	FCAPPNAME  string    `gorm:"column:FCAPPNAME;" json:"fcappname"  form:"fcappname" `
	FCAPRF     string    `gorm:"column:FCAPRF;" json:"fcaprf"  form:"fcaprf" `
	...
	FCEDINO_HB string    `gorm:"column:FCEDINO_HB;" json:"fcedino_hb"  form:"fcedino_hb" `
	FCEDINO_SP string    `gorm:"column:FCEDINO_SP;" json:"fcedino_sp"  form:"fcedino_sp" `
	FCGID      string    `gorm:"column:FCGID;" json:"fcgid"  form:"fcgid" `
	FCLID      string    `gorm:"column:FCLID;" json:"fclid"  form:"fclid" `
	FCLUPDAPP  string    `gorm:"column:FCLUPDAPP;" json:"fclupdapp"  form:"fclupdapp" `
	FCORGCODE  string    `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
	FCPAYEDINO string    `gorm:"column:FCPAYEDINO;" json:"fcpayedino"  form:"fcpayedino" `
...
func (Vedipric) TableName() string {
	return "VEDIPRIC"
}

func (obj *Vedipric) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
