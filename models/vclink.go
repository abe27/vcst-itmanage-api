...
type Vclink struct {
	...
	FCGLHEADCH string    `gorm:"column:FCGLHEADCH;" json:"fcglheadch"  form:"fcglheadch" `
	FCGLHEADPR string    `gorm:"column:FCGLHEADPR;" json:"fcglheadpr"  form:"fcglheadpr" `
...
func (Vclink) TableName() string {
	return "VCLINK"
}

func (obj *Vclink) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
