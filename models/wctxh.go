...
type Wctxh struct {
	...
	FCFRMOWC   string    `gorm:"column:FCFRMOWC;" json:"fcfrmowc"  form:"fcfrmowc" `
	...
	FCTOMOWC   string    `gorm:"column:FCTOMOWC;" json:"fctomowc"  form:"fctomowc" `
...
func (Wctxh) TableName() string {
	return "WCTXH"
}

func (obj *Wctxh) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
