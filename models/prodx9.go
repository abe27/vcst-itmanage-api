...
type Prodx9 struct {
	...
	FCKEEPTYPE string    `gorm:"column:FCKEEPTYPE;" json:"fckeeptype"  form:"fckeeptype" `
	...
	FCTESTTYPE string    `gorm:"column:FCTESTTYPE;" json:"fctesttype"  form:"fctesttype" `
	...
	FNDLOHPORT string    `gorm:"column:FNDLOHPORT;" json:"fndlohport"  form:"fndlohport" `
	FNMINPOBAT string    `gorm:"column:FNMINPOBAT;" json:"fnminpobat"  form:"fnminpobat" `
	FNRETEST_M string    `gorm:"column:FNRETEST_M;" json:"fnretest_m"  form:"fnretest_m" `
...
func (Prodx9) TableName() string {
	return "PRODX9"
}

func (obj *Prodx9) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
