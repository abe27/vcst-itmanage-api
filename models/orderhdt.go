...
type Orderhdt struct {
	...
	FNPRNCNT   string    `gorm:"column:FNPRNCNT;" json:"fnprncnt"  form:"fnprncnt" `
	...
	FTADDDATE  string    `gorm:"column:FTADDDATE;" json:"ftadddate"  form:"ftadddate" `
...
func (Orderhdt) TableName() string {
	return "ORDERHDT"
}

func (obj *Orderhdt) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
