...
type Budgetpd struct {
	...
	FCBUDGET   string    `gorm:"column:FCBUDGET;" json:"fcbudget"  form:"fcbudget" `
...
func (Budgetpd) TableName() string {
	return "BUDGETPD"
}

func (obj *Budgetpd) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
