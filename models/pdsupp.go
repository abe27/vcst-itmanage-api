...
type Pdsupp struct {
	...
	FNLTDPO    string `gorm:"column:FNLTDPO;" json:"fnltdpo"  form:"fnltdpo" `
	FNMINQTY   string `gorm:"column:FNMINQTY;" json:"fnminqty"  form:"fnminqty" `
	FNSTDPRICE string `gorm:"column:FNSTDPRICE;" json:"fnstdprice"  form:"fnstdprice" `
...
func (Pdsupp) TableName() string {
	return "PDSUPP"
}

func (obj *Pdsupp) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
