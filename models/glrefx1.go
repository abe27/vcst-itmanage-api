...
type Glrefx1 struct {
	...
	FNGRSWEIGH string    `gorm:"column:FNGRSWEIGH;" json:"fngrsweigh"  form:"fngrsweigh" `
	FNINSUREK  string    `gorm:"column:FNINSUREK;" json:"fninsurek"  form:"fninsurek" `
	FNNETWEIGH string    `gorm:"column:FNNETWEIGH;" json:"fnnetweigh"  form:"fnnetweigh" `
