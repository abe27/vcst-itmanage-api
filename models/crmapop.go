...
type Crmapop struct {
	...
	FCCHILDOP  string    `gorm:"column:FCCHILDOP;" json:"fcchildop"  form:"fcchildop" `
	...
	FDDEADLINE string    `gorm:"column:FDDEADLINE;" json:"fddeadline"  form:"fddeadline" `
	FIMILLISEC string    `gorm:"column:FIMILLISEC;" json:"fimillisec"  form:"fimillisec" `
	FMEXTRATAG string    `gorm:"column:FMEXTRATAG;" json:"fmextratag"  form:"fmextratag" `
	FNSALEFCAS string    `gorm:"column:FNSALEFCAS;" json:"fnsalefcas"  form:"fnsalefcas" `
...
func (Crmapop) TableName() string {
	return "CRMAPOP"
}

func (obj *Crmapop) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
