...
type Rdtaxcfg struct {
	FCACCESSKY string    `gorm:"column:FCACCESSKY;" json:"fcaccessky"  form:"fcaccessky" `
	...
	FCEXPORTTY string    `gorm:"column:FCEXPORTTY;" json:"fcexportty"  form:"fcexportty" `
	FCGID      string    `gorm:"column:FCGID;" json:"fcgid"  form:"fcgid" `
	FCLID      string    `gorm:"column:FCLID;" json:"fclid"  form:"fclid" `
	FCLUPDAPP  string    `gorm:"column:FCLUPDAPP;" json:"fclupdapp"  form:"fclupdapp" `
	FCORGCODE  string    `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
	FCPATH     string    `gorm:"column:FCPATH;" json:"fcpath"  form:"fcpath" `
	FCPROVIDER string    `gorm:"column:FCPROVIDER;" json:"fcprovider"  form:"fcprovider" `
	...
	FCUSERCODE string    `gorm:"column:FCUSERCODE;" json:"fcusercode"  form:"fcusercode" `
	FCUTIME    string    `gorm:"column:FCUTIME;" json:"fcutime"  form:"fcutime" `
	FIMILLISEC int64     `gorm:"column:FIMILLISEC;" json:"fimillisec"  form:"fimillisec" `
	FMCFG01    string    `gorm:"column:FMCFG01;" json:"fmcfg01"  form:"fmcfg01" `
...
func (Rdtaxcfg) TableName() string {
	return "RDTAXCFG"
}

func (obj *Rdtaxcfg) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
