...
type Emphwork struct {
	...
	FCDUTIES   string `gorm:"column:FCDUTIES;" json:"fcduties"  form:"fcduties" `
	...
	FMADDRESS  string `gorm:"column:FMADDRESS;" json:"fmaddress"  form:"fmaddress" `
	FMLEAVEWHY string `gorm:"column:FMLEAVEWHY;" json:"fmleavewhy"  form:"fmleavewhy" `
	FNOTHINC   string `gorm:"column:FNOTHINC;" json:"fnothinc"  form:"fnothinc" `
...
func (Emphwork) TableName() string {
	return "EMPHWORK"
}

func (obj *Emphwork) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
