...
type Vbudajh struct {
	...
	FCREQUESTB string `gorm:"column:FCREQUESTB;" json:"fcrequestb"  form:"fcrequestb" `
...
func (Vbudajh) TableName() string {
	return "VBUDAJH"
}

func (obj *Vbudajh) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
