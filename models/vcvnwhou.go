...
type Vcvnwhou struct {
	...
	FDSTOCKDAT string    `gorm:"column:FDSTOCKDAT;" json:"fdstockdat"  form:"fdstockdat" `
...
func (Vcvnwhou) TableName() string {
	return "VCVNWHOU"
}

func (obj *Vcvnwhou) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
