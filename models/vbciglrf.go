...
type Vbciglrf struct {
	...
	FCTHRDDLVR string    `gorm:"column:FCTHRDDLVR;" json:"fcthrddlvr"  form:"fcthrddlvr" `
...
func (Vbciglrf) TableName() string {
	return "VBCIGLRF"
}

func (obj *Vbciglrf) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
