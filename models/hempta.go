...
type Hempta struct {
	...
	FCRDTYPE   string    `gorm:"column:FCRDTYPE;" json:"fcrdtype"  form:"fcrdtype" `
	FCROUND    string    `gorm:"column:FCROUND;" json:"fcround"  form:"fcround" `
	FCSELTAG   string    `gorm:"column:FCSELTAG;" json:"fcseltag"  form:"fcseltag" `
	FCSHIFT    string    `gorm:"column:FCSHIFT;" json:"fcshift"  form:"fcshift" `
	FCSHIFTRF  string    `gorm:"column:FCSHIFTRF;" json:"fcshiftrf"  form:"fcshiftrf" `
...
func (Hempta) TableName() string {
	return "HEMPTA"
}

func (obj *Hempta) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
