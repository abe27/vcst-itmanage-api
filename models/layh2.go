...
type Layh2 struct {
	...
	FCISPART   string    `gorm:"column:FCISPART;" json:"fcispart"  form:"fcispart" `
	...
	FNBFPAYAMT string    `gorm:"column:FNBFPAYAMT;" json:"fnbfpayamt"  form:"fnbfpayamt" `
	FNBFPAYKE  string    `gorm:"column:FNBFPAYKE;" json:"fnbfpayke"  form:"fnbfpayke" `
