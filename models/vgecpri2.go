...
type Vgecpri2 struct {
	...
	FCVGECPRIC string `gorm:"column:FCVGECPRIC;" json:"fcvgecpric"  form:"fcvgecpric" `
...
func (Vgecpri2) TableName() string {
	return "VGECPRI2"
}

func (obj *Vgecpri2) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
