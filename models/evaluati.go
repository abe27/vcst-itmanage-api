...
type Evaluati struct {
	...
	FCISREMARK string    `gorm:"column:FCISREMARK;" json:"fcisremark"  form:"fcisremark" `
...
func (Evaluati) TableName() string {
	return "EVALUATI"
}

func (obj *Evaluati) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
