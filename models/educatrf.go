...
type Educatrf struct {
	...
	FCENDYEAR  string `gorm:"column:FCENDYEAR;" json:"fcendyear"  form:"fcendyear" `
	...
	FNAVGGRADE string `gorm:"column:FNAVGGRADE;" json:"fnavggrade"  form:"fnavggrade" `
...
func (Educatrf) TableName() string {
	return "EDUCATRF"
}

func (obj *Educatrf) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
