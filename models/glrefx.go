...
type Glrefx struct {
	...
	FCGLREFXH  string `gorm:"column:FCGLREFXH;" json:"fcglrefxh"  form:"fcglrefxh" `
	FCLID      string `gorm:"column:FCLID;" json:"fclid"  form:"fclid" `
	FCLUPDAPP  string `gorm:"column:FCLUPDAPP;" json:"fclupdapp"  form:"fclupdapp" `
	FCORGCODE  string `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
	FCREVALTYP string `gorm:"column:FCREVALTYP;" json:"fcrevaltyp"  form:"fcrevaltyp" `
	...
	FNOAMT     string `gorm:"column:FNOAMT;" json:"fnoamt"  form:"fnoamt" `
	FNOVATAMT  string `gorm:"column:FNOVATAMT;" json:"fnovatamt"  form:"fnovatamt" `
	FNOXRATE   string `gorm:"column:FNOXRATE;" json:"fnoxrate"  form:"fnoxrate" `
	FNREVALAMT string `gorm:"column:FNREVALAMT;" json:"fnrevalamt"  form:"fnrevalamt" `
	FNREVALVAT string `gorm:"column:FNREVALVAT;" json:"fnrevalvat"  form:"fnrevalvat" `
...
func (Glrefx) TableName() string {
	return "GLREFX"
}

func (obj *Glrefx) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
