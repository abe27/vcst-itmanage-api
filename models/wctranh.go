...
type Wctranh struct {
	...
	FCFRWKCTR  string `gorm:"column:FCFRWKCTR;" json:"fcfrwkctr"  form:"fcfrwkctr" `
	FCGID      string `gorm:"column:FCGID;" json:"fcgid"  form:"fcgid" `
	FCJOB      string `gorm:"column:FCJOB;" json:"fcjob"  form:"fcjob" `
	FCLID      string `gorm:"column:FCLID;" json:"fclid"  form:"fclid" `
	FCLUPDAPP  string `gorm:"column:FCLUPDAPP;" json:"fclupdapp"  form:"fclupdapp" `
	FCMBOOK    string `gorm:"column:FCMBOOK;" json:"fcmbook"  form:"fcmbook" `
	FCMMORDERH string `gorm:"column:FCMMORDERH;" json:"fcmmorderh"  form:"fcmmorderh" `
	...
	FCREFTO    string `gorm:"column:FCREFTO;" json:"fcrefto"  form:"fcrefto" `
	FCREFTYPE  string `gorm:"column:FCREFTYPE;" json:"fcreftype"  form:"fcreftype" `
	FCRFTYPE   string `gorm:"column:FCRFTYPE;" json:"fcrftype"  form:"fcrftype" `
	FCRTLABEL  string `gorm:"column:FCRTLABEL;" json:"fcrtlabel"  form:"fcrtlabel" `
...
func (Wctranh) TableName() string {
	return "WCTRANH"
}

func (obj *Wctranh) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
