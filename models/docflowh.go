...
type Docflowh struct{
     ...
     FCFLOWDESC string `gorm:"column:FCFLOWDESC;" json:"fcflowdesc"  form:"fcflowdesc" `
...
func (Docflowh) TableName() string{
return "DOCFLOWH"
}

func (obj *Docflowh) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
