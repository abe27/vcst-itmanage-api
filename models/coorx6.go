...
type Coorx6 struct {
	...
	FCBBANK    string `gorm:"column:FCBBANK;" json:"fcbbank"  form:"fcbbank" `
	FCBBRANCH  string `gorm:"column:FCBBRANCH;" json:"fcbbranch"  form:"fcbbranch" `
	FCBKACCTNO string `gorm:"column:FCBKACCTNO;" json:"fcbkacctno"  form:"fcbkacctno" `
...
func (Coorx6) TableName() string {
	return "COORX6"
}

func (obj *Coorx6) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
