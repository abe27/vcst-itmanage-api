...
type Glrefx3 struct {
	...
	FCREDLICEN string    `gorm:"column:FCREDLICEN;" json:"fcredlicen"  form:"fcredlicen" `
...
func (Glrefx3) TableName() string {
	return "GLREFX3"
}

func (obj *Glrefx3) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
