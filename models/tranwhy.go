...
type Tranwhy struct{
     ...
     FCRDDOCRSN string `gorm:"column:FCRDDOCRSN;" json:"fcrddocrsn"  form:"fcrddocrsn" `
...
func (Tranwhy) TableName() string{
return "TRANWHY"
}

func (obj *Tranwhy) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
