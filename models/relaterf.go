...
type Relaterf struct{
     ...
     FCEDULEVEL string `gorm:"column:FCEDULEVEL;" json:"fcedulevel"  form:"fcedulevel" `
     ...
     FCWELFARE string `gorm:"column:FCWELFARE;" json:"fcwelfare"  form:"fcwelfare" `
     FIMILLISEC string `gorm:"column:FIMILLISEC;" json:"fimillisec"  form:"fimillisec" `
     FMREMARK string `gorm:"column:FMREMARK;" json:"fmremark"  form:"fmremark" `
     FNMAXAGE string `gorm:"column:FNMAXAGE;" json:"fnmaxage"  form:"fnmaxage" `
     FNMAXPERSN string `gorm:"column:FNMAXPERSN;" json:"fnmaxpersn"  form:"fnmaxpersn" `
...
func (Relaterf) TableName() string{
return "RELATERF"
}

func (obj *Relaterf) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
