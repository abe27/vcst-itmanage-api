...
type Vnimtas3 struct {
	...
	FNREPADAY  string `gorm:"column:FNREPADAY;" json:"fnrepaday"  form:"fnrepaday" `
...
func (Vnimtas3) TableName() string {
	return "VNIMTAS3"
}

func (obj *Vnimtas3) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
