...
type Shiftrf struct {
	FCAFBEG    string    `gorm:"column:FCAFBEG;" json:"fcafbeg"  form:"fcafbeg" `
	FCAPPNAME  string    `gorm:"column:FCAPPNAME;" json:"fcappname"  form:"fcappname" `
	FCBAKYRHIS string    `gorm:"column:FCBAKYRHIS;" json:"fcbakyrhis"  form:"fcbakyrhis" `
	FCBFEND    string    `gorm:"column:FCBFEND;" json:"fcbfend"  form:"fcbfend" `
...
func (Shiftrf) TableName() string {
	return "SHIFTRF"
}

func (obj *Shiftrf) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
