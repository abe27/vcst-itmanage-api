...
type Vcwncoor struct {
	FCAPPNAME  string    `gorm:"column:FCAPPNAME;" json:"fcappname"  form:"fcappname" `
	FCBAKYRHIS string    `gorm:"column:FCBAKYRHIS;" json:"fcbakyrhis"  form:"fcbakyrhis" `
	FCBGNONINV string    `gorm:"column:FCBGNONINV;" json:"fcbgnoninv"  form:"fcbgnoninv" `
	...
	FCEDNONINV string    `gorm:"column:FCEDNONINV;" json:"fcednoninv"  form:"fcednoninv" `
...
func (Vcwncoor) TableName() string {
	return "VCWNCOOR"
}

func (obj *Vcwncoor) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
