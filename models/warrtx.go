...
type Warrtx struct {
	...
	FCAPPWARRT string    `gorm:"column:FCAPPWARRT;" json:"fcappwarrt"  form:"fcappwarrt" `
	...
	FCCOORDEAL string    `gorm:"column:FCCOORDEAL;" json:"fccoordeal"  form:"fccoordeal" `
	FCCOORENDU string    `gorm:"column:FCCOORENDU;" json:"fccoorendu"  form:"fccoorendu" `
	...
	FCMACODE   string    `gorm:"column:FCMACODE;" json:"fcmacode"  form:"fcmacode" `
	FCMATYPE   string    `gorm:"column:FCMATYPE;" json:"fcmatype"  form:"fcmatype" `
	...
	FCWARRANCD string    `gorm:"column:FCWARRANCD;" json:"fcwarrancd"  form:"fcwarrancd" `
	...
	FMOPTION   string    `gorm:"column:FMOPTION;" json:"fmoption"  form:"fmoption" `
...
func (Warrtx) TableName() string {
	return "WARRTX"
}

func (obj *Warrtx) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
