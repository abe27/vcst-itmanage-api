...
type Vdbdtrnh struct {
	FCAPPNAME  string `gorm:"column:FCAPPNAME;" json:"fcappname"  form:"fcappname" `
	FCAPPROVBY string `gorm:"column:FCAPPROVBY;" json:"fcapprovby"  form:"fcapprovby" `
	FCAPPROVE  string `gorm:"column:FCAPPROVE;" json:"fcapprove"  form:"fcapprove" `
	...
	FCEMPLCASH string `gorm:"column:FCEMPLCASH;" json:"fcemplcash"  form:"fcemplcash" `
	FCGID      string `gorm:"column:FCGID;" json:"fcgid"  form:"fcgid" `
	FCGLHEAD   string `gorm:"column:FCGLHEAD;" json:"fcglhead"  form:"fcglhead" `
	FCISCLOS   string `gorm:"column:FCISCLOS;" json:"fcisclos"  form:"fcisclos" `
	...
	FDCLEAR    string `gorm:"column:FDCLEAR;" json:"fdclear"  form:"fdclear" `
...
func (Vdbdtrnh) TableName() string {
	return "VDBDTRNH"
}

func (obj *Vdbdtrnh) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
