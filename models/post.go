...
type Post struct {
	...
	FCSHOWALL  string    `gorm:"column:FCSHOWALL;" json:"fcshowall"  form:"fcshowall" `
	FCSKID     string    `gorm:"primaryKey;column:FCSKID;size:8;unique;index;" json:"fcskid"  form:"fcskid" `
	FCSRCUPD   string    `gorm:"column:FCSRCUPD;" json:"fcsrcupd"  form:"fcsrcupd" `
	FCSTAT     string    `gorm:"column:FCSTAT;" json:"fcstat"  form:"fcstat" `
	FCSTEP     string    `gorm:"column:FCSTEP;" json:"fcstep"  form:"fcstep" `
	FCSTRUCCOD string    `gorm:"column:FCSTRUCCOD;" json:"fcstruccod"  form:"fcstruccod" `
	FCSYSSTAT  string    `gorm:"column:FCSYSSTAT;" json:"fcsysstat"  form:"fcsysstat" `
