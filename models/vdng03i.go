...
type Vdng03i struct {
	...
	FCHVDNG03  string    `gorm:"column:FCHVDNG03;" json:"fchvdng03"  form:"fchvdng03" `
	...
	FCVDNG03   string    `gorm:"column:FCVDNG03;" json:"fcvdng03"  form:"fcvdng03" `
...
func (Vdng03i) TableName() string {
	return "VDNG03I"
}

func (obj *Vdng03i) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
