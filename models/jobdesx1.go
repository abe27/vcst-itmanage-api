...
type Jobdesx1 struct{
     ...
     FCREFFIELD string `gorm:"column:FCREFFIELD;" json:"fcreffield"  form:"fcreffield" `
...
func (Jobdesx1) TableName() string{
return "JOBDESX1"
}

func (obj *Jobdesx1) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
