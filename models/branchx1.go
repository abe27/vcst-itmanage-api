...
type Branchx1 struct{
     ...
     FCCFGTYPE string `gorm:"column:FCCFGTYPE;" json:"fccfgtype"  form:"fccfgtype" `
     FCCONFIG string `gorm:"column:FCCONFIG;" json:"fcconfig"  form:"fcconfig" `
...
func (Branchx1) TableName() string{
return "BRANCHX1"
}

func (obj *Branchx1) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
