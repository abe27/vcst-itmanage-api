...
type Memo01 struct {
	...
	FCKEEPFILE string    `gorm:"column:FCKEEPFILE;" json:"fckeepfile"  form:"fckeepfile" `
	...
	FMMEMDATAB string    `gorm:"column:FMMEMDATAB;" json:"fmmemdatab"  form:"fmmemdatab" `
	FMMEMDATAC string    `gorm:"column:FMMEMDATAC;" json:"fmmemdatac"  form:"fmmemdatac" `
	FMMEMDATAD string    `gorm:"column:FMMEMDATAD;" json:"fmmemdatad"  form:"fmmemdatad" `
	FMMEMDATAE string    `gorm:"column:FMMEMDATAE;" json:"fmmemdatae"  form:"fmmemdatae" `
	FMMEMDATAF string    `gorm:"column:FMMEMDATAF;" json:"fmmemdataf"  form:"fmmemdataf" `
...
func (Memo01) TableName() string {
	return "MEMO01"
}

func (obj *Memo01) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
