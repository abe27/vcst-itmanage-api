...
type Pcontrac struct {
	...
	FCPROMOTYP string    `gorm:"column:FCPROMOTYP;" json:"fcpromotyp"  form:"fcpromotyp" `
...
func (Pcontrac) TableName() string {
	return "PCONTRAC"
}

func (obj *Pcontrac) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
