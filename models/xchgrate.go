...
type Xchgrate struct{
     ...
     FNRATE_TTB string `gorm:"column:FNRATE_TTB;" json:"fnrate_ttb"  form:"fnrate_ttb" `
     FNRATE_TTS string `gorm:"column:FNRATE_TTS;" json:"fnrate_tts"  form:"fnrate_tts" `
...
func (Xchgrate) TableName() string{
return "XCHGRATE"
}

func (obj *Xchgrate) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
