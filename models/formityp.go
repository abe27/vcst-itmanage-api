...
type Formityp struct {
	...
	FCOUTPUT   string    `gorm:"column:FCOUTPUT;" json:"fcoutput"  form:"fcoutput" `
	...
	FCUSE      string    `gorm:"column:FCUSE;" json:"fcuse"  form:"fcuse" `
...
func (Formityp) TableName() string {
	return "FORMITYP"
}

func (obj *Formityp) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
