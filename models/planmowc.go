...
type Planmowc struct{
     ...
     FCFRPMOP string `gorm:"column:FCFRPMOP;" json:"fcfrpmop"  form:"fcfrpmop" `
     ...
     FCTOPMOP string `gorm:"column:FCTOPMOP;" json:"fctopmop"  form:"fctopmop" `
...
func (Planmowc) TableName() string{
return "PLANMOWC"
}

func (obj *Planmowc) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
