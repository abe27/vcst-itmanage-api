...
type Budpdh struct {
	...
	FCACGRP    string `gorm:"column:FCACGRP;" json:"fcacgrp"  form:"fcacgrp" `
	...
	FCBUDGTYPE string `gorm:"column:FCBUDGTYPE;" json:"fcbudgtype"  form:"fcbudgtype" `
	FCBUDGYEAR string `gorm:"column:FCBUDGYEAR;" json:"fcbudgyear"  form:"fcbudgyear" `
	...
	FDBUDGDATE string `gorm:"column:FDBUDGDATE;" json:"fdbudgdate"  form:"fdbudgdate" `
	FIMILLISEC string `gorm:"column:FIMILLISEC;" json:"fimillisec"  form:"fimillisec" `
	FMEXTRATAG string `gorm:"column:FMEXTRATAG;" json:"fmextratag"  form:"fmextratag" `
	FNACTAMT   string `gorm:"column:FNACTAMT;" json:"fnactamt"  form:"fnactamt" `
	FNPDAMT    string `gorm:"column:FNPDAMT;" json:"fnpdamt"  form:"fnpdamt" `
	FNPDAMTK   string `gorm:"column:FNPDAMTK;" json:"fnpdamtk"  form:"fnpdamtk" `
	FNPDQTY    string `gorm:"column:FNPDQTY;" json:"fnpdqty"  form:"fnpdqty" `
...
func (Budpdh) TableName() string {
	return "BUDPDH"
}

func (obj *Budpdh) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
