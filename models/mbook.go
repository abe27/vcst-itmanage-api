...
type Mbook struct {
	...
	FCCTRLMO   string    `gorm:"column:FCCTRLMO;" json:"fcctrlmo"  form:"fcctrlmo" `
	...
	FCXFERDEFA string    `gorm:"column:FCXFERDEFA;" json:"fcxferdefa"  form:"fcxferdefa" `
	FDLOCKED   string    `gorm:"column:FDLOCKED;" json:"fdlocked"  form:"fdlocked" `
	FIMILLISEC string    `gorm:"column:FIMILLISEC;" json:"fimillisec"  form:"fimillisec" `
	FMEXTRATAG string    `gorm:"column:FMEXTRATAG;" json:"fmextratag"  form:"fmextratag" `
	FNRUNLEN   string    `gorm:"column:FNRUNLEN;" json:"fnrunlen"  form:"fnrunlen" `
...
func (Mbook) TableName() string {
	return "MBOOK"
}

func (obj *Mbook) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
