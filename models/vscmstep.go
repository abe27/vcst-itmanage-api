...
type Vscmstep struct {
	...
	FCLNKSTEP  string    `gorm:"column:FCLNKSTEP;" json:"fclnkstep"  form:"fclnkstep" `
	...
	FCRESVSTEP string    `gorm:"column:FCRESVSTEP;" json:"fcresvstep"  form:"fcresvstep" `
...
func (Vscmstep) TableName() string {
	return "VSCMSTEP"
}

func (obj *Vscmstep) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
