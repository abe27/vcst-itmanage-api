...
type Userdat struct {
	...
	FMMENU     string    `gorm:"column:FMMENU;" json:"fmmenu"  form:"fmmenu" `
	FMMENU2    string    `gorm:"column:FMMENU2;" json:"fmmenu2"  form:"fmmenu2" `
...
func (Userdat) TableName() string {
	return "USERDAT"
}

func (obj *Userdat) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
