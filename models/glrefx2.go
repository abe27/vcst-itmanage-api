...
type Glrefx2 struct{
     ...
     FCPFGRAD01 string `gorm:"column:FCPFGRAD01;" json:"fcpfgrad01"  form:"fcpfgrad01" `
     FCPFGRAD02 string `gorm:"column:FCPFGRAD02;" json:"fcpfgrad02"  form:"fcpfgrad02" `
     FCPFGRAD03 string `gorm:"column:FCPFGRAD03;" json:"fcpfgrad03"  form:"fcpfgrad03" `
     FCPFGRAD04 string `gorm:"column:FCPFGRAD04;" json:"fcpfgrad04"  form:"fcpfgrad04" `
     FCPFGRAD05 string `gorm:"column:FCPFGRAD05;" json:"fcpfgrad05"  form:"fcpfgrad05" `
...
func (Glrefx2) TableName() string{
return "GLREFX2"
}

func (obj *Glrefx2) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
