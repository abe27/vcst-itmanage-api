...
type Depref struct{
     ...
     FCREFPD2 string `gorm:"column:FCREFPD2;" json:"fcrefpd2"  form:"fcrefpd2" `
     ...
     FNPCNDEP string `gorm:"column:FNPCNDEP;" json:"fnpcndep"  form:"fnpcndep" `
...
func (Depref) TableName() string{
return "DEPREF"
}

func (obj *Depref) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
