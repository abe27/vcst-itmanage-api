...
type Vbsmpsrm struct {
	...
	FCMPSRM    string    `gorm:"column:FCMPSRM;" json:"fcmpsrm"  form:"fcmpsrm" `
	FCORGCODE  string    `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
	FCPLATED   string    `gorm:"column:FCPLATED;" json:"fcplated"  form:"fcplated" `
...
func (Vbsmpsrm) TableName() string {
	return "VBSMPSRM"
}

func (obj *Vbsmpsrm) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
