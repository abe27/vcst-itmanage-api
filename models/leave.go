...
type Leave struct {
	...
	FCHASDOCS  string `gorm:"column:FCHASDOCS;" json:"fchasdocs"  form:"fchasdocs" `
	...
	FNBFDAYS   string `gorm:"column:FNBFDAYS;" json:"fnbfdays"  form:"fnbfdays" `
...
func (obj *Leave) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
