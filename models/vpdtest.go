...
type Vpdtest struct {
	...
	FCTESTNO   string    `gorm:"column:FCTESTNO;" json:"fctestno"  form:"fctestno" `
	...
	FDLASTTEST string    `gorm:"column:FDLASTTEST;" json:"fdlasttest"  form:"fdlasttest" `
...
func (Vpdtest) TableName() string {
	return "VPDTEST"
}

func (obj *Vpdtest) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
