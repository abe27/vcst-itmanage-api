...
type Refpetty struct {
	...
	FCPETRETH  string `gorm:"column:FCPETRETH;" json:"fcpetreth"  form:"fcpetreth" `
	FCPETRETI  string `gorm:"column:FCPETRETI;" json:"fcpetreti"  form:"fcpetreti" `
...
func (Refpetty) TableName() string {
	return "REFPETTY"
}

func (obj *Refpetty) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
