...
type Whtrev struct {
	...
	FCWHTREV   string    `gorm:"column:FCWHTREV;" json:"fcwhtrev"  form:"fcwhtrev" `
	FIMILLISEC int64     `gorm:"column:FIMILLISEC;" json:"fimillisec"  form:"fimillisec" `
	FMEXTRATAG string    `gorm:"column:FMEXTRATAG;" json:"fmextratag"  form:"fmextratag" `
	FNTAXRATE  float64   `gorm:"column:FNTAXRATE;" json:"fntaxrate"  form:"fntaxrate" `
...
func (Whtrev) TableName() string {
	return "WHTREV"
}

func (obj *Whtrev) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
