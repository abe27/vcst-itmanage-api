...
type Costsect struct {
	...
	FNCOSTPORT string `gorm:"column:FNCOSTPORT;" json:"fncostport"  form:"fncostport" `
...
func (Costsect) TableName() string {
	return "COSTSECT"
}

func (obj *Costsect) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
