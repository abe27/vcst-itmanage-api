...
type Hstdtime struct {
	...
	FNPROCSEC  string    `gorm:"column:FNPROCSEC;" json:"fnprocsec"  form:"fnprocsec" `
...
func (Hstdtime) TableName() string {
	return "HSTDTIME"
}

func (obj *Hstdtime) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
