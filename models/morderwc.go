...
type Morderwc struct{
     ...
     FCFRMOOP string `gorm:"column:FCFRMOOP;" json:"fcfrmoop"  form:"fcfrmoop" `
     ...
     FCTOMOOP string `gorm:"column:FCTOMOOP;" json:"fctomoop"  form:"fctomoop" `
...
func (Morderwc) TableName() string{
return "MORDERWC"
}

func (obj *Morderwc) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
