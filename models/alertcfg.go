...
type Alertcfg struct {
	...
	FMCONFIG   string    `gorm:"column:FMCONFIG;" json:"fmconfig"  form:"fmconfig" `
	FMCONFIG2  string    `gorm:"column:FMCONFIG2;" json:"fmconfig2"  form:"fmconfig2" `
	FMCONFIG3  string    `gorm:"column:FMCONFIG3;" json:"fmconfig3"  form:"fmconfig3" `
	FMCONFIG4  string    `gorm:"column:FMCONFIG4;" json:"fmconfig4"  form:"fmconfig4" `
	FMCONFIG5  string    `gorm:"column:FMCONFIG5;" json:"fmconfig5"  form:"fmconfig5" `
...
func (Alertcfg) TableName() string {
	return "ALERTCFG"
}

func (obj *Alertcfg) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
