...
type Poscash struct {
	...
	FCREATETYP string    `gorm:"column:FCREATETYP;" json:"fcreatetyp"  form:"fcreatetyp" `
	FCSEQ      string    `gorm:"column:FCSEQ;" json:"fcseq"  form:"fcseq" `
	FCSKID     string    `gorm:"primaryKey;column:FCSKID;size:8;unique;index;" json:"fcskid"  form:"fcskid" `
	FCSRCUPD   string    `gorm:"column:FCSRCUPD;" json:"fcsrcupd"  form:"fcsrcupd" `
	FCTIME     string    `gorm:"column:FCTIME;" json:"fctime"  form:"fctime" `
	...
	FNCARD     string    `gorm:"column:FNCARD;" json:"fncard"  form:"fncard" `
	FNCARDAMT  string    `gorm:"column:FNCARDAMT;" json:"fncardamt"  form:"fncardamt" `
	FNCOUPON   string    `gorm:"column:FNCOUPON;" json:"fncoupon"  form:"fncoupon" `
	FNCOUPONAM string    `gorm:"column:FNCOUPONAM;" json:"fncouponam"  form:"fncouponam" `
	FNMONEY1   string    `gorm:"column:FNMONEY1;" json:"fnmoney1"  form:"fnmoney1" `
	FNMONEY10  string    `gorm:"column:FNMONEY10;" json:"fnmoney10"  form:"fnmoney10" `
	FNMONEY2   string    `gorm:"column:FNMONEY2;" json:"fnmoney2"  form:"fnmoney2" `
	FNMONEY3   string    `gorm:"column:FNMONEY3;" json:"fnmoney3"  form:"fnmoney3" `
	FNMONEY4   string    `gorm:"column:FNMONEY4;" json:"fnmoney4"  form:"fnmoney4" `
	FNMONEY5   string    `gorm:"column:FNMONEY5;" json:"fnmoney5"  form:"fnmoney5" `
	FNMONEY6   string    `gorm:"column:FNMONEY6;" json:"fnmoney6"  form:"fnmoney6" `
	FNMONEY7   string    `gorm:"column:FNMONEY7;" json:"fnmoney7"  form:"fnmoney7" `
	FNMONEY8   string    `gorm:"column:FNMONEY8;" json:"fnmoney8"  form:"fnmoney8" `
	FNMONEY9   string    `gorm:"column:FNMONEY9;" json:"fnmoney9"  form:"fnmoney9" `
...
func (Poscash) TableName() string {
	return "POSCASH"
}

func (obj *Poscash) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
