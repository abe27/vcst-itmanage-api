...
type Prodmrp struct {
	...
	FNALCVAL1  string    `gorm:"column:FNALCVAL1;" json:"fnalcval1"  form:"fnalcval1" `
	FNALCVAL2  string    `gorm:"column:FNALCVAL2;" json:"fnalcval2"  form:"fnalcval2" `
	FNALCVAL3  string    `gorm:"column:FNALCVAL3;" json:"fnalcval3"  form:"fnalcval3" `
...
func (Prodmrp) TableName() string {
	return "PRODMRP"
}

func (obj *Prodmrp) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
