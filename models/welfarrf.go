...
type Welfarrf struct {
	...
	FCDISEASE  string    `gorm:"column:FCDISEASE;" json:"fcdisease"  form:"fcdisease" `
	FCDOCNO    string    `gorm:"column:FCDOCNO;" json:"fcdocno"  form:"fcdocno" `
	...
	FCEMPERSON string    `gorm:"column:FCEMPERSON;" json:"fcemperson"  form:"fcemperson" `
	...
	FCPERIOD   string    `gorm:"column:FCPERIOD;" json:"fcperiod"  form:"fcperiod" `
...
func (Welfarrf) TableName() string {
	return "WELFARRF"
}

func (obj *Welfarrf) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
