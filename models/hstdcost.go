...
type Hstdcost struct {
	...
	FNEXPFAC   string    `gorm:"column:FNEXPFAC;" json:"fnexpfac"  form:"fnexpfac" `
	FNSCOSTKE1 string    `gorm:"column:FNSCOSTKE1;" json:"fnscostke1"  form:"fnscostke1" `
	FNSCOSTKE2 string    `gorm:"column:FNSCOSTKE2;" json:"fnscostke2"  form:"fnscostke2" `
...
func (Hstdcost) TableName() string {
	return "HSTDCOST"
}

func (obj *Hstdcost) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
