...
type Vsrcx1i struct {
	...
	FNBEGCTN   string    `gorm:"column:FNBEGCTN;" json:"fnbegctn"  form:"fnbegctn" `
	...
	FNENDCTN   string    `gorm:"column:FNENDCTN;" json:"fnendctn"  form:"fnendctn" `
...
func (Vsrcx1i) TableName() string {
	return "VSRCX1I"
}

func (obj *Vsrcx1i) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
