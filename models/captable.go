...
type Captable struct {
	...
	FCCAPTION  string    `gorm:"column:FCCAPTION;" json:"fccaption"  form:"fccaption" `
	FCCAPTION2 string    `gorm:"column:FCCAPTION2;" json:"fccaption2"  form:"fccaption2" `
	...
	FNCOLOR    string    `gorm:"column:FNCOLOR;" json:"fncolor"  form:"fncolor" `
...
func (Captable) TableName() string {
	return "CAPTABLE"
}

func (obj *Captable) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
