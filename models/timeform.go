...
type Timeform struct{
     ...
     FNBEG string `gorm:"column:FNBEG;" json:"fnbeg"  form:"fnbeg" `
     FNCOLUMN string `gorm:"column:FNCOLUMN;" json:"fncolumn"  form:"fncolumn" `
     FNEND string `gorm:"column:FNEND;" json:"fnend"  form:"fnend" `
...
func (Timeform) TableName() string{
return "TIMEFORM"
}

func (obj *Timeform) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
