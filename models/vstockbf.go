...
type Vstockbf struct{
     ...
     FNQTY1 string `gorm:"column:FNQTY1;" json:"fnqty1"  form:"fnqty1" `
     FNQTY2 string `gorm:"column:FNQTY2;" json:"fnqty2"  form:"fnqty2" `
...
func (Vstockbf) TableName() string{
return "VSTOCKBF"
}

func (obj *Vstockbf) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
