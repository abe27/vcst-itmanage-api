...
type Bookapv struct {
	...
	FCEDITAMT  string    `gorm:"column:FCEDITAMT;" json:"fceditamt"  form:"fceditamt" `
	FCEDITITEM string    `gorm:"column:FCEDITITEM;" json:"fcedititem"  form:"fcedititem" `
	...
	FCLIMITYPE string    `gorm:"column:FCLIMITYPE;" json:"fclimitype"  form:"fclimitype" `
	...
	FCRETUNAPV string    `gorm:"column:FCRETUNAPV;" json:"fcretunapv"  form:"fcretunapv" `
	FCSELTAG   string    `gorm:"column:FCSELTAG;" json:"fcseltag"  form:"fcseltag" `
	FCSEQ      string    `gorm:"column:FCSEQ;" json:"fcseq"  form:"fcseq" `
	FCSKID     string    `gorm:"primaryKey;column:FCSKID;size:8;unique;index;" json:"fcskid"  form:"fcskid" `
	FCSKIPSTEP string    `gorm:"column:FCSKIPSTEP;" json:"fcskipstep"  form:"fcskipstep" `
	...
	FNLIMIT    string    `gorm:"column:FNLIMIT;" json:"fnlimit"  form:"fnlimit" `
...
func (Bookapv) TableName() string {
	return "BOOKAPV"
}

func (obj *Bookapv) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
