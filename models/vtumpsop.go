...
type Vtumpsop struct {
	...
	FCVTUFMPS  string    `gorm:"column:FCVTUFMPS;" json:"fcvtufmps"  form:"fcvtufmps" `
...
func (Vtumpsop) TableName() string {
	return "VTUMPSOP"
}

func (obj *Vtumpsop) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
