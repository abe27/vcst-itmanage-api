...
type Routeway struct {
	...
	FNDISTANCE string `gorm:"column:FNDISTANCE;" json:"fndistance"  form:"fndistance" `
...
func (Routeway) TableName() string {
	return "ROUTEWAY"
}

func (obj *Routeway) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
