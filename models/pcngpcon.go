...
type Pcngpcon struct {
	...
	FNGPPCN    string    `gorm:"column:FNGPPCN;" json:"fngppcn"  form:"fngppcn" `
...
func (Pcngpcon) TableName() string {
	return "PCNGPCON"
}

func (obj *Pcngpcon) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
