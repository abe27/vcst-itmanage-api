...
type Mformbr struct {
	...
	FCREFTOFOR string    `gorm:"column:FCREFTOFOR;" json:"fcreftofor"  form:"fcreftofor" `
	FCREFTORNG string    `gorm:"column:FCREFTORNG;" json:"fcreftorng"  form:"fcreftorng" `
	...
	FCUSEINFOR string    `gorm:"column:FCUSEINFOR;" json:"fcuseinfor"  form:"fcuseinfor" `
...
func (Mformbr) TableName() string {
	return "MFORMBR"
}

func (obj *Mformbr) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
