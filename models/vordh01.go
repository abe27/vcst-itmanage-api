...
type Vordh01 struct{
     FCACCTEECD string `gorm:"column:FCACCTEECD;" json:"fcaccteecd"  form:"fcaccteecd" `
     FCAPPNAME string `gorm:"column:FCAPPNAME;" json:"fcappname"  form:"fcappname" `
     FCBOOK string `gorm:"column:FCBOOK;" json:"fcbook"  form:"fcbook" `
     FCBRANCH string `gorm:"column:FCBRANCH;" json:"fcbranch"  form:"fcbranch" `
     FCCODE string `gorm:"column:FCCODE;" json:"fccode"  form:"fccode" `
     FCCONSIGCD string `gorm:"column:FCCONSIGCD;" json:"fcconsigcd"  form:"fcconsigcd" `
     FCCORP string `gorm:"column:FCCORP;" json:"fccorp"  form:"fccorp" `
     FCCORRECTB string `gorm:"column:FCCORRECTB;" json:"fccorrectb"  form:"fccorrectb" `
     FCCREATEAP string `gorm:"column:FCCREATEAP;" json:"fccreateap"  form:"fccreateap" `
     FCCREATEBY string `gorm:"column:FCCREATEBY;" json:"fccreateby"  form:"fccreateby" `
     FCCUACC string `gorm:"column:FCCUACC;" json:"fccuacc"  form:"fccuacc" `
     FCCURSIGN string `gorm:"column:FCCURSIGN;" json:"fccursign"  form:"fccursign" `
     ...
     FCEUCODE string `gorm:"column:FCEUCODE;" json:"fceucode"  form:"fceucode" `
     FCEUORDNO string `gorm:"column:FCEUORDNO;" json:"fceuordno"  form:"fceuordno" `
     FCFREEIDEN string `gorm:"column:FCFREEIDEN;" json:"fcfreeiden"  form:"fcfreeiden" `
     FCFREIGPAY string `gorm:"column:FCFREIGPAY;" json:"fcfreigpay"  form:"fcfreigpay" `
     FCGID string `gorm:"column:FCGID;" json:"fcgid"  form:"fcgid" `
     FCLID string `gorm:"column:FCLID;" json:"fclid"  form:"fclid" `
     FCLUPDAPP string `gorm:"column:FCLUPDAPP;" json:"fclupdapp"  form:"fclupdapp" `
     FCORDERH string `gorm:"column:FCORDERH;" json:"fcorderh"  form:"fcorderh" `
     FCORDSTAT string `gorm:"column:FCORDSTAT;" json:"fcordstat"  form:"fcordstat" `
     FCORGCODE string `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
     FCPRCOTYPE string `gorm:"column:FCPRCOTYPE;" json:"fcprcotype"  form:"fcprcotype" `
     FCRCVEDI string `gorm:"column:FCRCVEDI;" json:"fcrcvedi"  form:"fcrcvedi" `
     FCRCVNAME string `gorm:"column:FCRCVNAME;" json:"fcrcvname"  form:"fcrcvname" `
     ...
     FCSENDNAME string `gorm:"column:FCSENDNAME;" json:"fcsendname"  form:"fcsendname" `
     ...
     FCURGENT string `gorm:"column:FCURGENT;" json:"fcurgent"  form:"fcurgent" `
...
func (Vordh01) TableName() string{
return "VORDH01"
}

func (obj *Vordh01) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
