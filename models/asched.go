...
type Asched struct {
	...
	FCCMDLINE  string    `gorm:"column:FCCMDLINE;" json:"fccmdline"  form:"fccmdline" `
	FCCORP     string    `gorm:"column:FCCORP;" json:"fccorp"  form:"fccorp" `
	FCCORRECTB string    `gorm:"column:FCCORRECTB;" json:"fccorrectb"  form:"fccorrectb" `
	FCCREATEAP string    `gorm:"column:FCCREATEAP;" json:"fccreateap"  form:"fccreateap" `
	FCCREATEBY string    `gorm:"column:FCCREATEBY;" json:"fccreateby"  form:"fccreateby" `
	FCCREATETY string    `gorm:"column:FCCREATETY;" json:"fccreatety"  form:"fccreatety" `
	FCCRPROG   string    `gorm:"column:FCCRPROG;" json:"fccrprog"  form:"fccrprog" `
	...
	FCOPTION   string    `gorm:"column:FCOPTION;" json:"fcoption"  form:"fcoption" `
	FCORGCODE  string    `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
	FCQCSYSOBJ string    `gorm:"column:FCQCSYSOBJ;" json:"fcqcsysobj"  form:"fcqcsysobj" `
	FCQNSYSOBJ string    `gorm:"column:FCQNSYSOBJ;" json:"fcqnsysobj"  form:"fcqnsysobj" `
	...
	FTTIME     string    `gorm:"column:FTTIME;" json:"fttime"  form:"fttime" `
}

func (Asched) TableName() string {
	return "ASCHED"
}

func (obj *Asched) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
