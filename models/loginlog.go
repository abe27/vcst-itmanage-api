...
type Loginlog struct {
	...
	FCADMIN    string    `gorm:"column:FCADMIN;" json:"fcadmin"  form:"fcadmin" `
	FCAPPNAME  string    `gorm:"column:FCAPPNAME;" json:"fcappname"  form:"fcappname" `
	FCCOMPNAME string    `gorm:"column:FCCOMPNAME;" json:"fccompname"  form:"fccompname" `
...
func (obj *Loginlog) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
