...
type Repset struct {
	...
	FCHMSG     string    `gorm:"column:FCHMSG;" json:"fchmsg"  form:"fchmsg" `
	...
	FMOPTDATA  string    `gorm:"column:FMOPTDATA;" json:"fmoptdata"  form:"fmoptdata" `
	FMOPTDATA2 string    `gorm:"column:FMOPTDATA2;" json:"fmoptdata2"  form:"fmoptdata2" `
	FNCOLID    float64   `gorm:"column:FNCOLID;" json:"fncolid"  form:"fncolid" `
	FNCOLSEQ   float64   `gorm:"column:FNCOLSEQ;" json:"fncolseq"  form:"fncolseq" `
	FNCOLWIDTH float64   `gorm:"column:FNCOLWIDTH;" json:"fncolwidth"  form:"fncolwidth" `
	FNISPRINT  float64   `gorm:"column:FNISPRINT;" json:"fnisprint"  form:"fnisprint" `
	FNITEMNO   float64   `gorm:"column:FNITEMNO;" json:"fnitemno"  form:"fnitemno" `
...
func (Repset) TableName() string {
	return "REPSET"
}

func (obj *Repset) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
