...
type Cmdcomm struct {
	...
	FCCMDNAME  string    `gorm:"column:FCCMDNAME;" json:"fccmdname"  form:"fccmdname" `
	...
	FCREGCOMP  string    `gorm:"column:FCREGCOMP;" json:"fcregcomp"  form:"fcregcomp" `
	...
	FMATTACH01 string    `gorm:"column:FMATTACH01;" json:"fmattach01"  form:"fmattach01" `
	FMATTACH02 string    `gorm:"column:FMATTACH02;" json:"fmattach02"  form:"fmattach02" `
	FMEMAIL01  string    `gorm:"column:FMEMAIL01;" json:"fmemail01"  form:"fmemail01" `
	FMEMAIL02  string    `gorm:"column:FMEMAIL02;" json:"fmemail02"  form:"fmemail02" `
	FMEXTRATAG string    `gorm:"column:FMEXTRATAG;" json:"fmextratag"  form:"fmextratag" `
	FMMSG01    string    `gorm:"column:FMMSG01;" json:"fmmsg01"  form:"fmmsg01" `
	FMMSG02    string    `gorm:"column:FMMSG02;" json:"fmmsg02"  form:"fmmsg02" `
...
func (Cmdcomm) TableName() string {
	return "CMDCOMM"
}

func (obj *Cmdcomm) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
