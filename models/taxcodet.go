...
type Taxcodet struct {
	...
	FDVALUE    string    `gorm:"column:FDVALUE;" json:"fdvalue"  form:"fdvalue" `
...
func (Taxcodet) TableName() string {
	return "TAXCODET"
}

func (obj *Taxcodet) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
