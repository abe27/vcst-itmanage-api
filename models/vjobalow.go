...
type Vjobalow struct {
	...
	FCNDUERATE string    `gorm:"column:FCNDUERATE;" json:"fcnduerate"  form:"fcnduerate" `
	FCORGCODE  string    `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
	FCOVERRATE string    `gorm:"column:FCOVERRATE;" json:"fcoverrate"  form:"fcoverrate" `
...
func (Vjobalow) TableName() string {
	return "VJOBALOW"
}

func (obj *Vjobalow) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
