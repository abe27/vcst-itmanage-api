...
type Person03 struct {
	...
	FCPERSONKY string    `gorm:"column:FCPERSONKY;" json:"fcpersonky"  form:"fcpersonky" `
...
func (Person03) TableName() string {
	return "PERSON03"
}

func (obj *Person03) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
