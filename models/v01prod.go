...
type V01prod struct {
	...
	FCPRODSUP  string `gorm:"column:FCPRODSUP;" json:"fcprodsup"  form:"fcprodsup" `
	FCSELTAG   string `gorm:"column:FCSELTAG;" json:"fcseltag"  form:"fcseltag" `
	FCSKID     string `gorm:"primaryKey;column:FCSKID;size:8;unique;index;" json:"fcskid"  form:"fcskid" `
	FCSRCUPD   string `gorm:"column:FCSRCUPD;" json:"fcsrcupd"  form:"fcsrcupd" `
	FCSTATUS2  string `gorm:"column:FCSTATUS2;" json:"fcstatus2"  form:"fcstatus2" `
	FCSUPP1    string `gorm:"column:FCSUPP1;" json:"fcsupp1"  form:"fcsupp1" `
	FCSUPP2    string `gorm:"column:FCSUPP2;" json:"fcsupp2"  form:"fcsupp2" `
	FCSUPP3    string `gorm:"column:FCSUPP3;" json:"fcsupp3"  form:"fcsupp3" `
...
func (V01prod) TableName() string {
	return "V01PROD"
}

func (obj *V01prod) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
