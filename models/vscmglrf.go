...
type Vscmglrf struct {
	...
	FCDELIMTHD string    `gorm:"column:FCDELIMTHD;" json:"fcdelimthd"  form:"fcdelimthd" `
	FCDELISTAT string    `gorm:"column:FCDELISTAT;" json:"fcdelistat"  form:"fcdelistat" `
	FCDELIZONE string    `gorm:"column:FCDELIZONE;" json:"fcdelizone"  form:"fcdelizone" `
	...
	FCLAYHZONE string    `gorm:"column:FCLAYHZONE;" json:"fclayhzone"  form:"fclayhzone" `
	...
	FNDELIPOIN string    `gorm:"column:FNDELIPOIN;" json:"fndelipoin"  form:"fndelipoin" `
...
func (Vscmglrf) TableName() string {
	return "VSCMGLRF"
}

func (obj *Vscmglrf) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
