...
type Paymnttr struct {
	...
	FCFRBANKAC string    `gorm:"column:FCFRBANKAC;" json:"fcfrbankac"  form:"fcfrbankac" `
	FCFRPAYMNT string    `gorm:"column:FCFRPAYMNT;" json:"fcfrpaymnt"  form:"fcfrpaymnt" `
	...
	FCTOPAYMNT string    `gorm:"column:FCTOPAYMNT;" json:"fctopaymnt"  form:"fctopaymnt" `
	...
	FNBANKFEE  string    `gorm:"column:FNBANKFEE;" json:"fnbankfee"  form:"fnbankfee" `
...
func (Paymnttr) TableName() string {
	return "PAYMNTTR"
}

func (obj *Paymnttr) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
