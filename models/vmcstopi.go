...
type Vmcstopi struct {
	...
	FCVMCSTOPH string `gorm:"column:FCVMCSTOPH;" json:"fcvmcstoph"  form:"fcvmcstoph" `
...
func (Vmcstopi) TableName() string {
	return "VMCSTOPI"
}

func (obj *Vmcstopi) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
