...
type Rdtaxhis struct {
	FCACTBYSYS string `gorm:"column:FCACTBYSYS;" json:"fcactbysys"  form:"fcactbysys" `
	FCACTDESC  string `gorm:"column:FCACTDESC;" json:"fcactdesc"  form:"fcactdesc" `
	FCACTION   string `gorm:"column:FCACTION;" json:"fcaction"  form:"fcaction" `
	FCACTIONBY string `gorm:"column:FCACTIONBY;" json:"fcactionby"  form:"fcactionby" `
	...
	FTACTION   string `gorm:"column:FTACTION;" json:"ftaction"  form:"ftaction" `
...
func (Rdtaxhis) TableName() string {
	return "RDTAXHIS"
}

func (obj *Rdtaxhis) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
