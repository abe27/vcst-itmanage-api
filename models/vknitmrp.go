...
type Vknitmrp struct{
     ...
     FCREFSKIDH string `gorm:"column:FCREFSKIDH;" json:"fcrefskidh"  form:"fcrefskidh" `
     FCREFSKIDI string `gorm:"column:FCREFSKIDI;" json:"fcrefskidi"  form:"fcrefskidi" `
...
func (Vknitmrp) TableName() string{
return "VKNITMRP"
}

func (obj *Vknitmrp) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
