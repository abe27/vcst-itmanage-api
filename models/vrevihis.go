...
type Vrevihis struct {
	...
	FCNEWLOCA  string    `gorm:"column:FCNEWLOCA;" json:"fcnewloca"  form:"fcnewloca" `
	FCOLDLOCA  string    `gorm:"column:FCOLDLOCA;" json:"fcoldloca"  form:"fcoldloca" `
...
func (Vrevihis) TableName() string {
	return "VREVIHIS"
}

func (obj *Vrevihis) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
