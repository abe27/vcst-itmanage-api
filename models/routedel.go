...
type Routedel struct {
	...
	FCMAINROUT string    `gorm:"column:FCMAINROUT;" json:"fcmainrout"  form:"fcmainrout" `
	...
	FCROUTETYP string    `gorm:"column:FCROUTETYP;" json:"fcroutetyp"  form:"fcroutetyp" `
...
func (Routedel) TableName() string {
	return "ROUTEDEL"
}

func (obj *Routedel) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
