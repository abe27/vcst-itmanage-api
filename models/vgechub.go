...
type Vgechub struct {
	...
	FCISMAIN   string    `gorm:"column:FCISMAIN;" json:"fcismain"  form:"fcismain" `
	FCLID      string    `gorm:"column:FCLID;" json:"fclid"  form:"fclid" `
	FCLUPDAPP  string    `gorm:"column:FCLUPDAPP;" json:"fclupdapp"  form:"fclupdapp" `
	FCMAINVHUB string    `gorm:"column:FCMAINVHUB;" json:"fcmainvhub"  form:"fcmainvhub" `
	...
	FNMTHCHRG  string    `gorm:"column:FNMTHCHRG;" json:"fnmthchrg"  form:"fnmthchrg" `
...
func (Vgechub) TableName() string {
	return "VGECHUB"
}

func (obj *Vgechub) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
