...
type Vapvpol struct{
     ...
     FNDISPULIM string `gorm:"column:FNDISPULIM;" json:"fndispulim"  form:"fndispulim" `
...
func (Vapvpol) TableName() string{
return "VAPVPOL"
}

func (obj *Vapvpol) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
