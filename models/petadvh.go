...
type Petadvh struct {
	...
	FCPETTYSET string    `gorm:"column:FCPETTYSET;" json:"fcpettyset"  form:"fcpettyset" `
	...
	FNADDAMT   string    `gorm:"column:FNADDAMT;" json:"fnaddamt"  form:"fnaddamt" `
	FNCLRAMT   string    `gorm:"column:FNCLRAMT;" json:"fnclramt"  form:"fnclramt" `
	FNFIRSTAMT string    `gorm:"column:FNFIRSTAMT;" json:"fnfirstamt"  form:"fnfirstamt" `
	FNRETRNAMT string    `gorm:"column:FNRETRNAMT;" json:"fnretrnamt"  form:"fnretrnamt" `
	...
	FNWDAMT    string    `gorm:"column:FNWDAMT;" json:"fnwdamt"  form:"fnwdamt" `
...
func (Petadvh) TableName() string {
	return "PETADVH"
}

func (obj *Petadvh) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
