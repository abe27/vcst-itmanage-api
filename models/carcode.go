...
type Carcode struct {
	...
	FCSOLDTYPE string `gorm:"column:FCSOLDTYPE;" json:"fcsoldtype"  form:"fcsoldtype" `
	...
	FDDATECA   string `gorm:"column:FDDATECA;" json:"fddateca"  form:"fddateca" `
...
func (Carcode) TableName() string {
	return "CARCODE"
}

func (obj *Carcode) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
