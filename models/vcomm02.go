...
type Vcomm02 struct {
	...
	FNCOMMPCN  string    `gorm:"column:FNCOMMPCN;" json:"fncommpcn"  form:"fncommpcn" `
	FNCOMMPU   string    `gorm:"column:FNCOMMPU;" json:"fncommpu"  form:"fncommpu" `
...
func (Vcomm02) TableName() string {
	return "VCOMM02"
}

func (obj *Vcomm02) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
