...
type Pdbranch struct{
     ...
     FNMAXSTOCK float64 `gorm:"column:FNMAXSTOCK;" json:"fnmaxstock"  form:"fnmaxstock" `
     FNMINSTOCK float64 `gorm:"column:FNMINSTOCK;" json:"fnminstock"  form:"fnminstock" `
...
func (Pdbranch) TableName() string{
return "PDBRANCH"
}

func (obj *Pdbranch) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
