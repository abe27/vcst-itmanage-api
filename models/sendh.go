...
type Sendh struct {
	...
	FCDELIEMP2 string    `gorm:"column:FCDELIEMP2;" json:"fcdeliemp2"  form:"fcdeliemp2" `
	FCDELIEMPL string    `gorm:"column:FCDELIEMPL;" json:"fcdeliempl"  form:"fcdeliempl" `
	FCDRVEMP2  string    `gorm:"column:FCDRVEMP2;" json:"fcdrvemp2"  form:"fcdrvemp2" `
...
func (Sendh) TableName() string {
	return "SENDH"
}

func (obj *Sendh) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
