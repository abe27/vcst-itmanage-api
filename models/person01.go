...
type Person01 struct {
	...
	FCADDR13   string    `gorm:"column:FCADDR13;" json:"fcaddr13"  form:"fcaddr13" `
	...
	FCADDR23   string    `gorm:"column:FCADDR23;" json:"fcaddr23"  form:"fcaddr23" `
	...
	FCMOB      string    `gorm:"column:FCMOB;" json:"fcmob"  form:"fcmob" `
	FCORGCODE  string    `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
	FCPERSON   string    `gorm:"column:FCPERSON;" json:"fcperson"  form:"fcperson" `
	FCPOSTAL1  string    `gorm:"column:FCPOSTAL1;" json:"fcpostal1"  form:"fcpostal1" `
	FCPOSTAL2  string    `gorm:"column:FCPOSTAL2;" json:"fcpostal2"  form:"fcpostal2" `
...
func (Person01) TableName() string {
	return "PERSON01"
}

func (obj *Person01) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
