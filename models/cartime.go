...
type Cartime struct{
     ...
     FCTIMECODE string `gorm:"column:FCTIMECODE;" json:"fctimecode"  form:"fctimecode" `
     FCTIMEDESC string `gorm:"column:FCTIMEDESC;" json:"fctimedesc"  form:"fctimedesc" `
...
func (Cartime) TableName() string{
return "CARTIME"
}

func (obj *Cartime) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
