...
type Hsubcost struct {
	...
	FCCURR     string    `gorm:"column:FCCURR;" json:"fccurr"  form:"fccurr" `
	...
	FNCOSTKE   string    `gorm:"column:FNCOSTKE;" json:"fncostke"  form:"fncostke" `
...
func (Hsubcost) TableName() string {
	return "HSUBCOST"
}

func (obj *Hsubcost) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
