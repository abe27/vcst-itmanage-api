...
type Vcupdcom struct{
     ...
     FNCOMMRATE string `gorm:"column:FNCOMMRATE;" json:"fncommrate"  form:"fncommrate" `
     FNGPRNG string `gorm:"column:FNGPRNG;" json:"fngprng"  form:"fngprng" `
...
func (Vcupdcom) TableName() string{
return "VCUPDCOM"
}

func (obj *Vcupdcom) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
