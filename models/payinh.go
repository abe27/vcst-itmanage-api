...
type Payinh struct{
     ...
     FCPAYITYPE string `gorm:"column:FCPAYITYPE;" json:"fcpayitype"  form:"fcpayitype" `
     ...
     FNCASHAMT string `gorm:"column:FNCASHAMT;" json:"fncashamt"  form:"fncashamt" `
     ...
     FNVATFEE string `gorm:"column:FNVATFEE;" json:"fnvatfee"  form:"fnvatfee" `
...
func (Payinh) TableName() string{
return "PAYINH"
}

func (obj *Payinh) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
