...
type Alertmsg struct {
	...
	FCMSG2USER string    `gorm:"column:FCMSG2USER;" json:"fcmsg2user"  form:"fcmsg2user" `
	...
	FMBFENTER  string    `gorm:"column:FMBFENTER;" json:"fmbfenter"  form:"fmbfenter" `
	FMBFSAVE   string    `gorm:"column:FMBFSAVE;" json:"fmbfsave"  form:"fmbfsave" `
	FMEXTRATAG string    `gorm:"column:FMEXTRATAG;" json:"fmextratag"  form:"fmextratag" `
	FMLOGINMSG string    `gorm:"column:FMLOGINMSG;" json:"fmloginmsg"  form:"fmloginmsg" `
	...
	FTALETDT   string    `gorm:"column:FTALETDT;" json:"ftaletdt"  form:"ftaletdt" `
...
func (Alertmsg) TableName() string {
	return "ALERTMSG"
}

func (obj *Alertmsg) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
