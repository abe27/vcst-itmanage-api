...
type Wkctrh struct{
     ...
     FNCRITICLE string `gorm:"column:FNCRITICLE;" json:"fncriticle"  form:"fncriticle" `
     FNLOTSIZE string `gorm:"column:FNLOTSIZE;" json:"fnlotsize"  form:"fnlotsize" `
     ...
     FNSTRICT string `gorm:"column:FNSTRICT;" json:"fnstrict"  form:"fnstrict" `
