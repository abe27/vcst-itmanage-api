...
type Flexvalu struct{
     FCABBR string `gorm:"column:FCABBR;" json:"fcabbr"  form:"fcabbr" `
     FCABBR2 string `gorm:"column:FCABBR2;" json:"fcabbr2"  form:"fcabbr2" `
...
func (Flexvalu) TableName() string{
return "FLEXVALU"
}

func (obj *Flexvalu) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
