...
type Debtalow struct{
     ...
     FNALOWAMT string `gorm:"column:FNALOWAMT;" json:"fnalowamt"  form:"fnalowamt" `
     FNBALALOW string `gorm:"column:FNBALALOW;" json:"fnbalalow"  form:"fnbalalow" `
...
func (Debtalow) TableName() string{
return "DEBTALOW"
}

func (obj *Debtalow) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
