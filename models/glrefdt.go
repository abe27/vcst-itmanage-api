...
type Glrefdt struct{
     ...
     FCLOCKPRN string `gorm:"column:FCLOCKPRN;" json:"fclockprn"  form:"fclockprn" `
     ...
     FTEDITDATE time.Time `gorm:"column:FTEDITDATE;" json:"fteditdate"  form:"fteditdate" default:"now"`
     FTLASTEDIT time.Time `gorm:"column:FTLASTEDIT;" json:"ftlastedit"  form:"ftlastedit" default:"now"`
     FTLASTUPD time.Time `gorm:"column:FTLASTUPD;" json:"ftlastupd"  form:"ftlastupd" default:"now"`
     FTPRNDATE string `gorm:"column:FTPRNDATE;" json:"ftprndate"  form:"ftprndate" `
     FTSRCUPD string `gorm:"column:FTSRCUPD;" json:"ftsrcupd"  form:"ftsrcupd" `
}
func (Glrefdt) TableName() string{
return "GLREFDT"
}

func (obj *Glrefdt) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
