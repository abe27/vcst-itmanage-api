...
type Dordehx1 struct{
     ...
     FMMASTERCD string `gorm:"column:FMMASTERCD;" json:"fmmastercd"  form:"fmmastercd" `
...
func (Dordehx1) TableName() string{
return "DORDEHX1"
}

func (obj *Dordehx1) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
