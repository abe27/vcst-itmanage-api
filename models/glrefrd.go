...
type Glrefrd struct{
     ...
     FMRDTAX01 string `gorm:"column:FMRDTAX01;" json:"fmrdtax01"  form:"fmrdtax01" `
     FMRDTAX02 string `gorm:"column:FMRDTAX02;" json:"fmrdtax02"  form:"fmrdtax02" `
     FMRDTAX03 string `gorm:"column:FMRDTAX03;" json:"fmrdtax03"  form:"fmrdtax03" `
     FMRDTAX04 string `gorm:"column:FMRDTAX04;" json:"fmrdtax04"  form:"fmrdtax04" `
     FMRDTAX05 string `gorm:"column:FMRDTAX05;" json:"fmrdtax05"  form:"fmrdtax05" `
...
func (Glrefrd) TableName() string{
return "GLREFRD"
}

func (obj *Glrefrd) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
