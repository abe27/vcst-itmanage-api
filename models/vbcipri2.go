...
type Vbcipri2 struct {
	...
	FCPRODFREE string `gorm:"column:FCPRODFREE;" json:"fcprodfree"  form:"fcprodfree" `
...
func (Vbcipri2) TableName() string {
	return "VBCIPRI2"
}

func (obj *Vbcipri2) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
