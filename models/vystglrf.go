...
type Vystglrf struct {
	...
	FCNMESDWHT string    `gorm:"column:FCNMESDWHT;" json:"fcnmesdwht"  form:"fcnmesdwht" `
	...
	FCSKDSDWHT string    `gorm:"column:FCSKDSDWHT;" json:"fcskdsdwht"  form:"fcskdsdwht" `
...
func (Vystglrf) TableName() string {
	return "VYSTGLRF"
}

func (obj *Vystglrf) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
