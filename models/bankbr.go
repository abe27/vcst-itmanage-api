...
type Bankbr struct {
	FCADDRESS1 string    `gorm:"column:FCADDRESS1;" json:"fcaddress1"  form:"fcaddress1" `
	FCADDRESS2 string    `gorm:"column:FCADDRESS2;" json:"fcaddress2"  form:"fcaddress2" `
	...
	FCBRISO    string    `gorm:"column:FCBRISO;" json:"fcbriso"  form:"fcbriso" `
	FCCNTRYISO string    `gorm:"column:FCCNTRYISO;" json:"fccntryiso"  form:"fccntryiso" `
	...
	FCPOSTISO  string    `gorm:"column:FCPOSTISO;" json:"fcpostiso"  form:"fcpostiso" `
...
func (Bankbr) TableName() string {
	return "BANKBR"
}

func (obj *Bankbr) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
