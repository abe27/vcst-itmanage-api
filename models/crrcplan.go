...
type Crrcplan struct {
	...
	FCDAY      string    `gorm:"column:FCDAY;" json:"fcday"  form:"fcday" `
	...
	FCRECPLAN  string    `gorm:"column:FCRECPLAN;" json:"fcrecplan"  form:"fcrecplan" `
...
func (Crrcplan) TableName() string {
	return "CRRCPLAN"
}

func (obj *Crrcplan) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
