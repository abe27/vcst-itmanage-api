...
type Apvpo struct {
	...
	FNLIMPDOC  string    `gorm:"column:FNLIMPDOC;" json:"fnlimpdoc"  form:"fnlimpdoc" `
	FNLIMPMTH  string    `gorm:"column:FNLIMPMTH;" json:"fnlimpmth"  form:"fnlimpmth" `
...
func (Apvpo) TableName() string {
	return "APVPO"
}

func (obj *Apvpo) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
