...
type Boqgrph struct {
	...
	FCLEVEL1   string `gorm:"column:FCLEVEL1;" json:"fclevel1"  form:"fclevel1" `
	FCLEVEL2   string `gorm:"column:FCLEVEL2;" json:"fclevel2"  form:"fclevel2" `
	FCLEVEL3   string `gorm:"column:FCLEVEL3;" json:"fclevel3"  form:"fclevel3" `
...
func (Boqgrph) TableName() string {
	return "BOQGRPH"
}

func (obj *Boqgrph) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
