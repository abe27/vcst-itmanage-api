...
type Tran2why struct {
	...
	FCSFCHR    string    `gorm:"column:FCSFCHR;" json:"fcsfchr"  form:"fcsfchr" `
...
func (Tran2why) TableName() string {
	return "TRAN2WHY"
}

func (obj *Tran2why) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
