...
type Vsksctdh struct {
	...
	FCDOCREF   string    `gorm:"column:FCDOCREF;" json:"fcdocref"  form:"fcdocref" `
	...
	FMMEMO     string    `gorm:"column:FMMEMO;" json:"fmmemo"  form:"fmmemo" `
	FNTOTPRICE string    `gorm:"column:FNTOTPRICE;" json:"fntotprice"  form:"fntotprice" `
...
func (Vsksctdh) TableName() string {
	return "VSKSCTDH"
}

func (obj *Vsksctdh) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
