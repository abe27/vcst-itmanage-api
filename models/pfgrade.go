...
type Pfgrade struct {
	...
	FCCATAG    string `gorm:"column:FCCATAG;" json:"fccatag"  form:"fccatag" `
	...
	FNSCORE    string `gorm:"column:FNSCORE;" json:"fnscore"  form:"fnscore" `
...
func (Pfgrade) TableName() string {
	return "PFGRADE"
}

func (obj *Pfgrade) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
