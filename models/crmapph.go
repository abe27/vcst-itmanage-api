...
type Crmapph struct {
	...
	FCAPPSUBJ  string    `gorm:"column:FCAPPSUBJ;" json:"fcappsubj"  form:"fcappsubj" `
	...
	FCCRCONT   string    `gorm:"column:FCCRCONT;" json:"fccrcont"  form:"fccrcont" `
	FCCREATEAP string    `gorm:"column:FCCREATEAP;" json:"fccreateap"  form:"fccreateap" `
	FCCREATEBY string    `gorm:"column:FCCREATEBY;" json:"fccreateby"  form:"fccreateby" `
	FCCREATETY string    `gorm:"column:FCCREATETY;" json:"fccreatety"  form:"fccreatety" `
	FCCRMLEAD  string    `gorm:"column:FCCRMLEAD;" json:"fccrmlead"  form:"fccrmlead" `
	...
	FCISQOUTE  string    `gorm:"column:FCISQOUTE;" json:"fcisqoute"  form:"fcisqoute" `
	FCJOB      string    `gorm:"column:FCJOB;" json:"fcjob"  form:"fcjob" `
	FCLID      string    `gorm:"column:FCLID;" json:"fclid"  form:"fclid" `
	FCLUPDAPP  string    `gorm:"column:FCLUPDAPP;" json:"fclupdapp"  form:"fclupdapp" `
	FCORGCODE  string    `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
	FCPOSTTIME string    `gorm:"column:FCPOSTTIME;" json:"fcposttime"  form:"fcposttime" `
	...
	FCTIMEAPP  string    `gorm:"column:FCTIMEAPP;" json:"fctimeapp"  form:"fctimeapp" `
	...
	FDDATEAPP  string    `gorm:"column:FDDATEAPP;" json:"fddateapp"  form:"fddateapp" `
	FDPOSTDATE string    `gorm:"column:FDPOSTDATE;" json:"fdpostdate"  form:"fdpostdate" `
	FDREPDATE  string    `gorm:"column:FDREPDATE;" json:"fdrepdate"  form:"fdrepdate" `
	FIMILLISEC string    `gorm:"column:FIMILLISEC;" json:"fimillisec"  form:"fimillisec" `
	FMDOCFLOW  string    `gorm:"column:FMDOCFLOW;" json:"fmdocflow"  form:"fmdocflow" `
	FMEXTRATAG string    `gorm:"column:FMEXTRATAG;" json:"fmextratag"  form:"fmextratag" `
	FMREMARK   string    `gorm:"column:FMREMARK;" json:"fmremark"  form:"fmremark" `
	FMREPDTAI2 string    `gorm:"column:FMREPDTAI2;" json:"fmrepdtai2"  form:"fmrepdtai2" `
	FMREPDTAI3 string    `gorm:"column:FMREPDTAI3;" json:"fmrepdtai3"  form:"fmrepdtai3" `
	FMREPDTAI4 string    `gorm:"column:FMREPDTAI4;" json:"fmrepdtai4"  form:"fmrepdtai4" `
	FMREPDTAI5 string    `gorm:"column:FMREPDTAI5;" json:"fmrepdtai5"  form:"fmrepdtai5" `
	FMREPDTAIL string    `gorm:"column:FMREPDTAIL;" json:"fmrepdtail"  form:"fmrepdtail" `
...
func (Crmapph) TableName() string {
	return "CRMAPPH"
}

func (obj *Crmapph) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
