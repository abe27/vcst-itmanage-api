...
type Trainemp struct {
	...
	FCISJOIN   string    `gorm:"column:FCISJOIN;" json:"fcisjoin"  form:"fcisjoin" `
	...
	FNAFPOINT  string    `gorm:"column:FNAFPOINT;" json:"fnafpoint"  form:"fnafpoint" `
	FNBFPOINT  string    `gorm:"column:FNBFPOINT;" json:"fnbfpoint"  form:"fnbfpoint" `
...
func (Trainemp) TableName() string {
	return "TRAINEMP"
}

func (obj *Trainemp) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
