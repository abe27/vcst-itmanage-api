...
type Currency struct {
	...
	FCQCRDCURR string    `gorm:"column:FCQCRDCURR;" json:"fcqcrdcurr"  form:"fcqcrdcurr" `
	...
	FNRATE     float64   `gorm:"column:FNRATE;" json:"fnrate"  form:"fnrate" `
...
func (obj *Currency) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
