...
type Planhour struct {
	...
	FNOT1HOUR  string `gorm:"column:FNOT1HOUR;" json:"fnot1hour"  form:"fnot1hour" `
	FNOT2HOUR  string `gorm:"column:FNOT2HOUR;" json:"fnot2hour"  form:"fnot2hour" `
	FNOT3HOUR  string `gorm:"column:FNOT3HOUR;" json:"fnot3hour"  form:"fnot3hour" `
	FNOTHOUR   string `gorm:"column:FNOTHOUR;" json:"fnothour"  form:"fnothour" `
	FNSTDHOUR  string `gorm:"column:FNSTDHOUR;" json:"fnstdhour"  form:"fnstdhour" `
	...
	FNWORKHOUR string `gorm:"column:FNWORKHOUR;" json:"fnworkhour"  form:"fnworkhour" `
...
func (Planhour) TableName() string {
	return "PLANHOUR"
}

func (obj *Planhour) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
