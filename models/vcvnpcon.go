...
type Vcvnpcon struct {
	...
	FCPCONTRA  string    `gorm:"column:FCPCONTRA;" json:"fcpcontra"  form:"fcpcontra" `
...
func (Vcvnpcon) TableName() string {
	return "VCVNPCON"
}

func (obj *Vcvnpcon) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
