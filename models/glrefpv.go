...
type Glrefpv struct{
     ...
     FCCOMMSTR string `gorm:"column:FCCOMMSTR;" json:"fccommstr"  form:"fccommstr" `
     ...
     FCEMPLPV string `gorm:"column:FCEMPLPV;" json:"fcemplpv"  form:"fcemplpv" `
     ...
     FNCOMMBASE string `gorm:"column:FNCOMMBASE;" json:"fncommbase"  form:"fncommbase" `
...
func (Glrefpv) TableName() string{
return "GLREFPV"
}

func (obj *Glrefpv) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
