...
type Plant struct {
	...
	FCISSUOVER string    `gorm:"column:FCISSUOVER;" json:"fcissuover"  form:"fcissuover" `
	...
	FCRCVOVER  string    `gorm:"column:FCRCVOVER;" json:"fcrcvover"  form:"fcrcvover" `
	FCRETOVER  string    `gorm:"column:FCRETOVER;" json:"fcretover"  form:"fcretover" `
	...
	FNAVAILABI string    `gorm:"column:FNAVAILABI;" json:"fnavailabi"  form:"fnavailabi" `
	FNDCAP     string    `gorm:"column:FNDCAP;" json:"fndcap"  form:"fndcap" `
	FNNSHIFT   string    `gorm:"column:FNNSHIFT;" json:"fnnshift"  form:"fnnshift" `
	FNOEE      string    `gorm:"column:FNOEE;" json:"fnoee"  form:"fnoee" `
	FNPERFORM  string    `gorm:"column:FNPERFORM;" json:"fnperform"  form:"fnperform" `
	FNQUALITY  string    `gorm:"column:FNQUALITY;" json:"fnquality"  form:"fnquality" `
...
func (obj *Plant) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
