...
type Orderhx2 struct{
     FCADVSTR string `gorm:"column:FCADVSTR;" json:"fcadvstr"  form:"fcadvstr" `
     ...
     FCPENALSTR string `gorm:"column:FCPENALSTR;" json:"fcpenalstr"  form:"fcpenalstr" `
     FCREFTYPE string `gorm:"column:FCREFTYPE;" json:"fcreftype"  form:"fcreftype" `
     FCRETENSTR string `gorm:"column:FCRETENSTR;" json:"fcretenstr"  form:"fcretenstr" `
     ...
     FCWARRSTR string `gorm:"column:FCWARRSTR;" json:"fcwarrstr"  form:"fcwarrstr" `
...
func (Orderhx2) TableName() string{
return "ORDERHX2"
}

func (obj *Orderhx2) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
