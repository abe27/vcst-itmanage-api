...
type Refstr struct {
	...
	FCSTR01    string `gorm:"column:FCSTR01;" json:"fcstr01"  form:"fcstr01" `
	FCSTR02    string `gorm:"column:FCSTR02;" json:"fcstr02"  form:"fcstr02" `
	FCSTR03    string `gorm:"column:FCSTR03;" json:"fcstr03"  form:"fcstr03" `
	FCSTR04    string `gorm:"column:FCSTR04;" json:"fcstr04"  form:"fcstr04" `
	FCSTR05    string `gorm:"column:FCSTR05;" json:"fcstr05"  form:"fcstr05" `
...
func (Refstr) TableName() string {
	return "REFSTR"
}

func (obj *Refstr) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
