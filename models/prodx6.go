...
type Prodx6 struct {
	...
	FCSEG01    string    `gorm:"column:FCSEG01;" json:"fcseg01"  form:"fcseg01" `
	FCSEG02    string    `gorm:"column:FCSEG02;" json:"fcseg02"  form:"fcseg02" `
	FCSEG03    string    `gorm:"column:FCSEG03;" json:"fcseg03"  form:"fcseg03" `
	FCSEG04    string    `gorm:"column:FCSEG04;" json:"fcseg04"  form:"fcseg04" `
	FCSEG05    string    `gorm:"column:FCSEG05;" json:"fcseg05"  form:"fcseg05" `
	FCSEG06    string    `gorm:"column:FCSEG06;" json:"fcseg06"  form:"fcseg06" `
	FCSEG07    string    `gorm:"column:FCSEG07;" json:"fcseg07"  form:"fcseg07" `
	FCSEG08    string    `gorm:"column:FCSEG08;" json:"fcseg08"  form:"fcseg08" `
	FCSEG09    string    `gorm:"column:FCSEG09;" json:"fcseg09"  form:"fcseg09" `
	FCSEG10    string    `gorm:"column:FCSEG10;" json:"fcseg10"  form:"fcseg10" `
...
func (Prodx6) TableName() string {
	return "PRODX6"
}

func (obj *Prodx6) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
