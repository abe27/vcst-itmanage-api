...
type Formulas struct{
     ...
     FCPRICETYP string `gorm:"column:FCPRICETYP;" json:"fcpricetyp"  form:"fcpricetyp" `
...
func (Formulas) TableName() string{
return "FORMULAS"
}

func (obj *Formulas) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
