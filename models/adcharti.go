...
type Adcharti struct {
	...
	FCTXCHARTI string    `gorm:"column:FCTXCHARTI;" json:"fctxcharti"  form:"fctxcharti" `
...
func (Adcharti) TableName() string {
	return "ADCHARTI"
}

func (obj *Adcharti) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
