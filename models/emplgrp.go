...
type Emplgrp struct {
	...
	FCPOSTTYPE string    `gorm:"column:FCPOSTTYPE;" json:"fcposttype"  form:"fcposttype" `
...
func (Emplgrp) TableName() string {
	return "EMPLGRP"
}

func (obj *Emplgrp) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
