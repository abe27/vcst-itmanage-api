...
type Vbudh struct {
	FCAPCNTI   string    `gorm:"column:FCAPCNTI;" json:"fcapcnti"  form:"fcapcnti" `
	...
	FCISCNTIN  string    `gorm:"column:FCISCNTIN;" json:"fciscntin"  form:"fciscntin" `
	...
	FDEDCNTI   string    `gorm:"column:FDEDCNTI;" json:"fdedcnti"  form:"fdedcnti" `
	FDSTCNTI   string    `gorm:"column:FDSTCNTI;" json:"fdstcnti"  form:"fdstcnti" `
...
func (Vbudh) TableName() string {
	return "VBUDH"
}

func (obj *Vbudh) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
