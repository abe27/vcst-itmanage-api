...
func (Vcomrath) TableName() string {
	return "VCOMRATH"
}

func (obj *Vcomrath) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
