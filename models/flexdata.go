...
type Flexdata struct {
	...
	FCFLEXTYPE string    `gorm:"column:FCFLEXTYPE;" json:"fcflextype"  form:"fcflextype" `
	FCFLEXVALU string    `gorm:"column:FCFLEXVALU;" json:"fcflexvalu"  form:"fcflexvalu" `
	...
	FCMASTERDA string    `gorm:"column:FCMASTERDA;" json:"fcmasterda"  form:"fcmasterda" `
	...
	FDFLEXVALU string    `gorm:"column:FDFLEXVALU;" json:"fdflexvalu"  form:"fdflexvalu" `
	FIMILLISEC string    `gorm:"column:FIMILLISEC;" json:"fimillisec"  form:"fimillisec" `
	FMEXTRATAG string    `gorm:"column:FMEXTRATAG;" json:"fmextratag"  form:"fmextratag" `
	FMFLEXVALU string    `gorm:"column:FMFLEXVALU;" json:"fmflexvalu"  form:"fmflexvalu" `
	FNFLEXVALU string    `gorm:"column:FNFLEXVALU;" json:"fnflexvalu"  form:"fnflexvalu" `
	...
	FTFLEXVALU string    `gorm:"column:FTFLEXVALU;" json:"ftflexvalu"  form:"ftflexvalu" `
	FTLASTEDIT time.Time `gorm:"column:FTLASTEDIT;" json:"ftlastedit"  form:"ftlastedit" `
	FTLASTUPD  string    `gorm:"column:FTLASTUPD;" json:"ftlastupd"  form:"ftlastupd" `
	FTSRCUPD   string    `gorm:"column:FTSRCUPD;" json:"ftsrcupd"  form:"ftsrcupd" `
}

func (Flexdata) TableName() string {
	return "FLEXDATA"
}

func (obj *Flexdata) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
