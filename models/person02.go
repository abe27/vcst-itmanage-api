...
type Person02 struct {
	...
	FCCONTPOST string    `gorm:"column:FCCONTPOST;" json:"fccontpost"  form:"fccontpost" `
	FCCONTSECT string    `gorm:"column:FCCONTSECT;" json:"fccontsect"  form:"fccontsect" `
	...
	FCISDECIDE string    `gorm:"column:FCISDECIDE;" json:"fcisdecide"  form:"fcisdecide" `
	FCISPOV    string    `gorm:"column:FCISPOV;" json:"fcispov"  form:"fcispov" `
	...
	FCTASK     string    `gorm:"column:FCTASK;" json:"fctask"  form:"fctask" `
	...
	FDSTCONT   string    `gorm:"column:FDSTCONT;" json:"fdstcont"  form:"fdstcont" `
...
func (Person02) TableName() string {
	return "PERSON02"
}

func (obj *Person02) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
