...
type Pdgrp struct{
     ...
     FCACCSTOCK string `gorm:"column:FCACCSTOCK;" json:"fcaccstock"  form:"fcaccstock" `
     ...
     FNDLOHPORT float64 `gorm:"column:FNDLOHPORT;" json:"fndlohport"  form:"fndlohport" `
...
func (Pdgrp) TableName() string{
return "PDGRP"
}

func (obj *Pdgrp) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
