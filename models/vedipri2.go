...
type Vedipri2 struct {
	...
	FCVEDIPRIC string    `gorm:"column:FCVEDIPRIC;" json:"fcvedipric"  form:"fcvedipric" `
	FIMILLISEC string    `gorm:"column:FIMILLISEC;" json:"fimillisec"  form:"fimillisec" `
	FMEXTRATAG string    `gorm:"column:FMEXTRATAG;" json:"fmextratag"  form:"fmextratag" `
	FNBEGQTY   string    `gorm:"column:FNBEGQTY;" json:"fnbegqty"  form:"fnbegqty" `
	FNENDQTY   string    `gorm:"column:FNENDQTY;" json:"fnendqty"  form:"fnendqty" `
...
func (Vedipri2) TableName() string {
	return "VEDIPRI2"
}

func (obj *Vedipri2) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
