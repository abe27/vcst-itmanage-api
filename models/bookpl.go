...
type Bookpl struct {
	...
	FNBARCODE  string    `gorm:"column:FNBARCODE;" json:"fnbarcode"  form:"fnbarcode" `
	FNNITEM    string    `gorm:"column:FNNITEM;" json:"fnnitem"  form:"fnnitem" `
...
func (Bookpl) TableName() string {
	return "BOOKPL"
}

func (obj *Bookpl) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
