...
type Taxtrg struct {
	...
	FCAMTTYPE  string `gorm:"column:FCAMTTYPE;" json:"fcamttype"  form:"fcamttype" `
	...
	FCEXCEPT   string `gorm:"column:FCEXCEPT;" json:"fcexcept"  form:"fcexcept" `
	...
	FCPCNWHICH string `gorm:"column:FCPCNWHICH;" json:"fcpcnwhich"  form:"fcpcnwhich" `
	...
	FCWARNTYPE string `gorm:"column:FCWARNTYPE;" json:"fcwarntype"  form:"fcwarntype" `
	...
	FNMAXPCN   string `gorm:"column:FNMAXPCN;" json:"fnmaxpcn"  form:"fnmaxpcn" `
	FNMINAMT   string `gorm:"column:FNMINAMT;" json:"fnminamt"  form:"fnminamt" `
	FNMINPCN   string `gorm:"column:FNMINPCN;" json:"fnminpcn"  form:"fnminpcn" `
...
func (Taxtrg) TableName() string {
	return "TAXTRG"
}

func (obj *Taxtrg) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
