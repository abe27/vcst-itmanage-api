...
type Promoth struct {
	...
	FCGETRIGTY string `gorm:"column:FCGETRIGTY;" json:"fcgetrigty"  form:"fcgetrigty" `
	FCGETWHAT  string `gorm:"column:FCGETWHAT;" json:"fcgetwhat"  form:"fcgetwhat" `
	FCGID      string `gorm:"column:FCGID;" json:"fcgid"  form:"fcgid" `
	FCJOB      string `gorm:"column:FCJOB;" json:"fcjob"  form:"fcjob" `
	FCLID      string `gorm:"column:FCLID;" json:"fclid"  form:"fclid" `
	FCLUPDAPP  string `gorm:"column:FCLUPDAPP;" json:"fclupdapp"  form:"fclupdapp" `
	FCMULTIBIL string `gorm:"column:FCMULTIBIL;" json:"fcmultibil"  form:"fcmultibil" `
	...
	FCTRGTTYPE string `gorm:"column:FCTRGTTYPE;" json:"fctrgttype"  form:"fctrgttype" `
	...
	FNREPEAT   string `gorm:"column:FNREPEAT;" json:"fnrepeat"  form:"fnrepeat" `
	FNRIGQTY   string `gorm:"column:FNRIGQTY;" json:"fnrigqty"  form:"fnrigqty" `
	FNTARGET   string `gorm:"column:FNTARGET;" json:"fntarget"  form:"fntarget" `
...
func (Promoth) TableName() string {
	return "PROMOTH"
}

func (obj *Promoth) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
