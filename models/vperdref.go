...
type Vperdref struct {
	...
	FCVPERIOD  string    `gorm:"column:FCVPERIOD;" json:"fcvperiod"  form:"fcvperiod" `
...
func (Vperdref) TableName() string {
	return "VPERDREF"
}

func (obj *Vperdref) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
