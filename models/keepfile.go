...
type Keepfile struct {
	...
	FCBACKMACH string    `gorm:"column:FCBACKMACH;" json:"fcbackmach"  form:"fcbackmach" `
	FCBACKPATH string    `gorm:"column:FCBACKPATH;" json:"fcbackpath"  form:"fcbackpath" `
	...
	FCTABMEMO  string    `gorm:"column:FCTABMEMO;" json:"fctabmemo"  form:"fctabmemo" `
	...
	FTDATEMODI string    `gorm:"column:FTDATEMODI;" json:"ftdatemodi"  form:"ftdatemodi" `
...
func (Keepfile) TableName() string {
	return "KEEPFILE"
}

func (obj *Keepfile) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
