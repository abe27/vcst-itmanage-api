...
type Mcaldepr struct {
	...
	FCQCGLHEAD string    `gorm:"column:FCQCGLHEAD;" json:"fcqcglhead"  form:"fcqcglhead" `
...
func (Mcaldepr) TableName() string {
	return "MCALDEPR"
}

func (obj *Mcaldepr) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
