...
type Hdatatrn struct {
	...
	FCDATA     string    `gorm:"column:FCDATA;" json:"fcdata"  form:"fcdata" `
	...
	FCFROM     string    `gorm:"column:FCFROM;" json:"fcfrom"  form:"fcfrom" `
	FCFROMDET  string    `gorm:"column:FCFROMDET;" json:"fcfromdet"  form:"fcfromdet" `
	...
	FCQCFROM   string    `gorm:"column:FCQCFROM;" json:"fcqcfrom"  form:"fcqcfrom" `
	...
	FTTRAN     string    `gorm:"column:FTTRAN;" json:"fttran"  form:"fttran" `
}

func (Hdatatrn) TableName() string {
	return "HDATATRN"
}

func (obj *Hdatatrn) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
