...
type Bank struct {
	FCABBCODE  string    `gorm:"column:FCABBCODE;" json:"fcabbcode"  form:"fcabbcode" `
	...
	FCBANKISO  string    `gorm:"column:FCBANKISO;" json:"fcbankiso"  form:"fcbankiso" `
	FCBOTCODE  string    `gorm:"column:FCBOTCODE;" json:"fcbotcode"  form:"fcbotcode" `
	FCCCFEE    string    `gorm:"column:FCCCFEE;" json:"fcccfee"  form:"fcccfee" `
...
func (obj *Bank) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
