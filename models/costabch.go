...
type Costabch struct {
	...
	FDFROMDATE string `gorm:"column:FDFROMDATE;" json:"fdfromdate"  form:"fdfromdate" `
	FDTODATE   string `gorm:"column:FDTODATE;" json:"fdtodate"  form:"fdtodate" `
...
func (Costabch) TableName() string {
	return "COSTABCH"
}

func (obj *Costabch) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
