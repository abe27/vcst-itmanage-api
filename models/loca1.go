...
type Loca1 struct {
	...
	FCBLOCK    string    `gorm:"column:FCBLOCK;" json:"fcblock"  form:"fcblock" `
	...
	FCLOCK     string    `gorm:"column:FCLOCK;" json:"fclock"  form:"fclock" `
	...
	FCSHELF    string    `gorm:"column:FCSHELF;" json:"fcshelf"  form:"fcshelf" `
	...
	FMDESC2    string    `gorm:"column:FMDESC2;" json:"fmdesc2"  form:"fmdesc2" `
...
func (Loca1) TableName() string {
	return "LOCA1"
}

func (obj *Loca1) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
