...
type Pdbr2 struct {
	...
	FNEOQTY    string `gorm:"column:FNEOQTY;" json:"fneoqty"  form:"fneoqty" `
	FNMAXSTOCK string `gorm:"column:FNMAXSTOCK;" json:"fnmaxstock"  form:"fnmaxstock" `
	FNMINSTOCK string `gorm:"column:FNMINSTOCK;" json:"fnminstock"  form:"fnminstock" `
	FNREORDERP string `gorm:"column:FNREORDERP;" json:"fnreorderp"  form:"fnreorderp" `
	FNSAFETYQT string `gorm:"column:FNSAFETYQT;" json:"fnsafetyqt"  form:"fnsafetyqt" `
...
func (Pdbr2) TableName() string {
	return "PDBR2"
}

func (obj *Pdbr2) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
