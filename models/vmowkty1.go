...
type Vmowkty1 struct {
	...
	FCVMOWK1   string    `gorm:"column:FCVMOWK1;" json:"fcvmowk1"  form:"fcvmowk1" `
...
func (Vmowkty1) TableName() string {
	return "VMOWKTY1"
}

func (obj *Vmowkty1) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
