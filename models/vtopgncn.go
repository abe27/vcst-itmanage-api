...
type Vtopgncn struct{
     ...
     FCGENCNFRM string `gorm:"column:FCGENCNFRM;" json:"fcgencnfrm"  form:"fcgencnfrm" `
     FCGID string `gorm:"column:FCGID;" json:"fcgid"  form:"fcgid" `
     FCGPSTR string `gorm:"column:FCGPSTR;" json:"fcgpstr"  form:"fcgpstr" `
     FCISGENCN string `gorm:"column:FCISGENCN;" json:"fcisgencn"  form:"fcisgencn" `
...
func (Vtopgncn) TableName() string{
return "VTOPGNCN"
}

func (obj *Vtopgncn) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
