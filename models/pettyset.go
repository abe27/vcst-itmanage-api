...
type Pettyset struct{
     ...
     FCCLOSEDBY string `gorm:"column:FCCLOSEDBY;" json:"fcclosedby"  form:"fcclosedby" `
     ...
     FNRCVAMT string `gorm:"column:FNRCVAMT;" json:"fnrcvamt"  form:"fnrcvamt" `
...
func (Pettyset) TableName() string{
return "PETTYSET"
}
