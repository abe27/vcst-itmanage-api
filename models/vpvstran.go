...
type Vpvstran struct{
     ...
     FCDRIVERID string `gorm:"column:FCDRIVERID;" json:"fcdriverid"  form:"fcdriverid" `
     ...
     FCPERMIT string `gorm:"column:FCPERMIT;" json:"fcpermit"  form:"fcpermit" `
     ...
     FCTRANCORP string `gorm:"column:FCTRANCORP;" json:"fctrancorp"  form:"fctrancorp" `
     ...
     FNPBYCUST string `gorm:"column:FNPBYCUST;" json:"fnpbycust"  form:"fnpbycust" `
     FNPBYDEST string `gorm:"column:FNPBYDEST;" json:"fnpbydest"  form:"fnpbydest" `
     FNPBYSUPP string `gorm:"column:FNPBYSUPP;" json:"fnpbysupp"  form:"fnpbysupp" `
     FNTRANTOT string `gorm:"column:FNTRANTOT;" json:"fntrantot"  form:"fntrantot" `
...
func (Vpvstran) TableName() string{
return "VPVSTRAN"
}

func (obj *Vpvstran) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
