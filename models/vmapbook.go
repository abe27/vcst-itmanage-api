...
type Vmapbook struct {
	...
	FCVMBOOK   string `gorm:"column:FCVMBOOK;" json:"fcvmbook"  form:"fcvmbook" `
	FCVSECT    string `gorm:"column:FCVSECT;" json:"fcvsect"  form:"fcvsect" `
	FCVWHOUSE  string `gorm:"column:FCVWHOUSE;" json:"fcvwhouse"  form:"fcvwhouse" `
...
func (Vmapbook) TableName() string {
	return "VMAPBOOK"
}

func (obj *Vmapbook) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
