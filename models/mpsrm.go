...
type Mpsrm struct {
	...
	FDPLAN     string    `gorm:"column:FDPLAN;" json:"fdplan"  form:"fdplan" `
	FDSTART    string    `gorm:"column:FDSTART;" json:"fdstart"  form:"fdstart" `
	FIMILLISEC string    `gorm:"column:FIMILLISEC;" json:"fimillisec"  form:"fimillisec" `
	FMEXTRATAG string    `gorm:"column:FMEXTRATAG;" json:"fmextratag"  form:"fmextratag" `
	FNOTHER1   string    `gorm:"column:FNOTHER1;" json:"fnother1"  form:"fnother1" `
	FNOTHER2   string    `gorm:"column:FNOTHER2;" json:"fnother2"  form:"fnother2" `
...
func (Mpsrm) TableName() string {
	return "MPSRM"
}

func (obj *Mpsrm) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
