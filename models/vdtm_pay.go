...
type Vdtm_pay struct {
	FCAPPNAME  string    `gorm:"column:FCAPPNAME;" json:"fcappname"  form:"fcappname" `
	FCAPPNO    string    `gorm:"column:FCAPPNO;" json:"fcappno"  form:"fcappno" `
...
func (Vdtm_pay) TableName() string {
	return "VDTM_PAY"
}

func (obj *Vdtm_pay) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
