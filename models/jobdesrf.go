...
type Jobdesrf struct{
     ...
     FCJOBDESC string `gorm:"column:FCJOBDESC;" json:"fcjobdesc"  form:"fcjobdesc" `
...
func (Jobdesrf) TableName() string{
return "JOBDESRF"
}

func (obj *Jobdesrf) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
