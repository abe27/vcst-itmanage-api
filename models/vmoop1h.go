...
type Vmoop1h struct {
	...
	FCMORDEROP string    `gorm:"column:FCMORDEROP;" json:"fcmorderop"  form:"fcmorderop" `
...
func (Vmoop1h) TableName() string {
	return "VMOOP1H"
}

func (obj *Vmoop1h) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
