...
type Morderh struct {
	...
	FCBATCHNO  string `gorm:"column:FCBATCHNO;" json:"fcbatchno"  form:"fcbatchno" `
	...
	FCGENSKID  string `gorm:"column:FCGENSKID;" json:"fcgenskid"  form:"fcgenskid" `
	FCGENTAB   string `gorm:"column:FCGENTAB;" json:"fcgentab"  form:"fcgentab" `
...
func (Morderh) TableName() string {
	return "MORDERH"
}

func (obj *Morderh) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
