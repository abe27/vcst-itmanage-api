...
type Trainexp struct {
	...
	FNUSEAMT   string    `gorm:"column:FNUSEAMT;" json:"fnuseamt"  form:"fnuseamt" `
...
func (Trainexp) TableName() string {
	return "TRAINEXP"
}

func (obj *Trainexp) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
