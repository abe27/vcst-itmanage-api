...
type Copdmap struct {
	...
	FCCOLOR1   string    `gorm:"column:FCCOLOR1;" json:"fccolor1"  form:"fccolor1" `
	FCCOLOR2   string    `gorm:"column:FCCOLOR2;" json:"fccolor2"  form:"fccolor2" `
	...
	FCFCHRMDL  string    `gorm:"column:FCFCHRMDL;" json:"fcfchrmdl"  form:"fcfchrmdl" `
	FCFIXPRICE string    `gorm:"column:FCFIXPRICE;" json:"fcfixprice"  form:"fcfixprice" `
	...
	FCMAPBRAND string    `gorm:"column:FCMAPBRAND;" json:"fcmapbrand"  form:"fcmapbrand" `
	FCMAPCODE  string    `gorm:"column:FCMAPCODE;" json:"fcmapcode"  form:"fcmapcode" `
	FCMAPMODEL string    `gorm:"column:FCMAPMODEL;" json:"fcmapmodel"  form:"fcmapmodel" `
	FCMAPNAME  string    `gorm:"column:FCMAPNAME;" json:"fcmapname"  form:"fcmapname" `
	...
	FCPARTDES2 string    `gorm:"column:FCPARTDES2;" json:"fcpartdes2"  form:"fcpartdes2" `
	FCPARTDESC string    `gorm:"column:FCPARTDESC;" json:"fcpartdesc"  form:"fcpartdesc" `
	FCPARTNO   string    `gorm:"column:FCPARTNO;" json:"fcpartno"  form:"fcpartno" `
	...
	FNPACKWG   string    `gorm:"column:FNPACKWG;" json:"fnpackwg"  form:"fnpackwg" `
	...
	FNUMQTYSTD string    `gorm:"column:FNUMQTYSTD;" json:"fnumqtystd"  form:"fnumqtystd" `
...
func (Copdmap) TableName() string {
	return "COPDMAP"
}

func (obj *Copdmap) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
