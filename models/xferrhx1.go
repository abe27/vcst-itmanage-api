...
type Xferrhx1 struct{
     FCAPPNAME string `gorm:"column:FCAPPNAME;" json:"fcappname"  form:"fcappname" `
     FCAPVSECT string `gorm:"column:FCAPVSECT;" json:"fcapvsect"  form:"fcapvsect" `
     ...
     FCISDLVY string `gorm:"column:FCISDLVY;" json:"fcisdlvy"  form:"fcisdlvy" `
     FCISEXDLVY string `gorm:"column:FCISEXDLVY;" json:"fcisexdlvy"  form:"fcisexdlvy" `
     FCISREC string `gorm:"column:FCISREC;" json:"fcisrec"  form:"fcisrec" `
     FCISREQPAS string `gorm:"column:FCISREQPAS;" json:"fcisreqpas"  form:"fcisreqpas" `
     FCLID string `gorm:"column:FCLID;" json:"fclid"  form:"fclid" `
     FCLUPDAPP string `gorm:"column:FCLUPDAPP;" json:"fclupdapp"  form:"fclupdapp" `
     FCORGCODE string `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
     FCRECEMPL string `gorm:"column:FCRECEMPL;" json:"fcrecempl"  form:"fcrecempl" `
     FCREDREGIS string `gorm:"column:FCREDREGIS;" json:"fcredregis"  form:"fcredregis" `
...
func (Xferrhx1) TableName() string{
return "XFERRHX1"
}

func (obj *Xferrhx1) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
