...
type Jbbudget struct {
	...
	FNADJAMT   string    `gorm:"column:FNADJAMT;" json:"fnadjamt"  form:"fnadjamt" `
...
func (Jbbudget) TableName() string {
	return "JBBUDGET"
}

func (obj *Jbbudget) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
