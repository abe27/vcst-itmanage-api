...
type Accestyp struct {
	...
	FCISSTD    string    `gorm:"column:FCISSTD;" json:"fcisstd"  form:"fcisstd" `
...
func (Accestyp) TableName() string {
	return "ACCESTYP"
}

func (obj *Accestyp) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
