...
type Txcharth struct{
     ...
     FCDBDFORM string `gorm:"column:FCDBDFORM;" json:"fcdbdform"  form:"fcdbdform" `
     FCDBDSHEET string `gorm:"column:FCDBDSHEET;" json:"fcdbdsheet"  form:"fcdbdsheet" `
     FCDBDTAG string `gorm:"column:FCDBDTAG;" json:"fcdbdtag"  form:"fcdbdtag" `
     ...
     FCTAXONOMY string `gorm:"column:FCTAXONOMY;" json:"fctaxonomy"  form:"fctaxonomy" `
     ...
     FNLEVEL int64 `gorm:"column:FNLEVEL;" json:"fnlevel"  form:"fnlevel" `
...
func (Txcharth) TableName() string{
return "TXCHARTH"
}

func (obj *Txcharth) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
