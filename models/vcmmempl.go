...
type Vcmmempl struct {
	...
	FCINVOICE  string    `gorm:"column:FCINVOICE;" json:"fcinvoice"  form:"fcinvoice" `
	FCLID      string    `gorm:"column:FCLID;" json:"fclid"  form:"fclid" `
	FCLUPDAPP  string    `gorm:"column:FCLUPDAPP;" json:"fclupdapp"  form:"fclupdapp" `
	FCORGCODE  string    `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
	FCPERIOD   string    `gorm:"column:FCPERIOD;" json:"fcperiod"  form:"fcperiod" `
	FCPRODUCT  string    `gorm:"column:FCPRODUCT;" json:"fcproduct"  form:"fcproduct" `
	FCSALE     string    `gorm:"column:FCSALE;" json:"fcsale"  form:"fcsale" `
	FCSELTAG   string    `gorm:"column:FCSELTAG;" json:"fcseltag"  form:"fcseltag" `
	FCSKID     string    `gorm:"primaryKey;column:FCSKID;size:8;unique;index;" json:"fcskid"  form:"fcskid" `
	FCSRCUPD   string    `gorm:"column:FCSRCUPD;" json:"fcsrcupd"  form:"fcsrcupd" `
	FCTARGET   string    `gorm:"column:FCTARGET;" json:"fctarget"  form:"fctarget" `
...
func (Vcmmempl) TableName() string {
	return "VCMMEMPL"
}

func (obj *Vcmmempl) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
