...
type Payinref struct{
     ...
     FCPAYINH string `gorm:"column:FCPAYINH;" json:"fcpayinh"  form:"fcpayinh" `
...
func (Payinref) TableName() string{
return "PAYINREF"
}

func (obj *Payinref) BeforeCreate(tx *gorm.DB) (err error){
id, _ := g.New(8)
obj.FCSKID = id
return}
