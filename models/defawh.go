...
type Defawh struct {
	...
	FCQCBR01   string    `gorm:"column:FCQCBR01;" json:"fcqcbr01"  form:"fcqcbr01" `
	FCQCBR02   string    `gorm:"column:FCQCBR02;" json:"fcqcbr02"  form:"fcqcbr02" `
	FCQCBR03   string    `gorm:"column:FCQCBR03;" json:"fcqcbr03"  form:"fcqcbr03" `
	FCQCCORP01 string    `gorm:"column:FCQCCORP01;" json:"fcqccorp01"  form:"fcqccorp01" `
	FCQCCORP02 string    `gorm:"column:FCQCCORP02;" json:"fcqccorp02"  form:"fcqccorp02" `
	FCQCCORP03 string    `gorm:"column:FCQCCORP03;" json:"fcqccorp03"  form:"fcqccorp03" `
	FCQCWH01   string    `gorm:"column:FCQCWH01;" json:"fcqcwh01"  form:"fcqcwh01" `
	FCQCWH02   string    `gorm:"column:FCQCWH02;" json:"fcqcwh02"  form:"fcqcwh02" `
	FCQCWH03   string    `gorm:"column:FCQCWH03;" json:"fcqcwh03"  form:"fcqcwh03" `
	...
	FCWHBOI    string    `gorm:"column:FCWHBOI;" json:"fcwhboi"  form:"fcwhboi" `
...
func (Defawh) TableName() string {
	return "DEFAWH"
}

func (obj *Defawh) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
