...
type Locmovh1 struct {
	...
	FCFRLOCA1  string    `gorm:"column:FCFRLOCA1;" json:"fcfrloca1"  form:"fcfrloca1" `
	...
	FCTOLOCA1  string    `gorm:"column:FCTOLOCA1;" json:"fctoloca1"  form:"fctoloca1" `
	...
	FCWBOOK    string    `gorm:"column:FCWBOOK;" json:"fcwbook"  form:"fcwbook" `
...
func (Locmovh1) TableName() string {
	return "LOCMOVH1"
}

func (obj *Locmovh1) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
