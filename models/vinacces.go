...
type Vinacces struct {
	FCACCESTYP string    `gorm:"column:FCACCESTYP;" json:"fcaccestyp"  form:"fcaccestyp" `
	FCAPPNAME  string    `gorm:"column:FCAPPNAME;" json:"fcappname"  form:"fcappname" `
	FCCARACCES string    `gorm:"column:FCCARACCES;" json:"fccaracces"  form:"fccaracces" `
	...
	FCINSTSECT string    `gorm:"column:FCINSTSECT;" json:"fcinstsect"  form:"fcinstsect" `
	FCISCHECK  string    `gorm:"column:FCISCHECK;" json:"fcischeck"  form:"fcischeck" `
	FCISFIX    string    `gorm:"column:FCISFIX;" json:"fcisfix"  form:"fcisfix" `
	FCLID      string    `gorm:"column:FCLID;" json:"fclid"  form:"fclid" `
	FCLUPDAPP  string    `gorm:"column:FCLUPDAPP;" json:"fclupdapp"  form:"fclupdapp" `
	FCORGCODE  string    `gorm:"column:FCORGCODE;" json:"fcorgcode"  form:"fcorgcode" `
	FCREFMAST  string    `gorm:"column:FCREFMAST;" json:"fcrefmast"  form:"fcrefmast" `
	...
	FDINSTALL  string    `gorm:"column:FDINSTALL;" json:"fdinstall"  form:"fdinstall" `
	FDRECACCES string    `gorm:"column:FDRECACCES;" json:"fdrecacces"  form:"fdrecacces" `
...
func (Vinacces) TableName() string {
	return "VINACCES"
}
