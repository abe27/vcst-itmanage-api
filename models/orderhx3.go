...
type Orderhx3 struct {
	...
	FMPICTNAME string    `gorm:"column:FMPICTNAME;" json:"fmpictname"  form:"fmpictname" `
...
func (Orderhx3) TableName() string {
	return "ORDERHX3"
}

func (obj *Orderhx3) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
