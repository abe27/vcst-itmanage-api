...
type Tnevali struct {
	...
	FCEVALUATI string    `gorm:"column:FCEVALUATI;" json:"fcevaluati"  form:"fcevaluati" `
	...
	FCTNEVALH  string    `gorm:"column:FCTNEVALH;" json:"fctnevalh"  form:"fctnevalh" `
	...
	FNVALUE    string    `gorm:"column:FNVALUE;" json:"fnvalue"  form:"fnvalue" `
...
func (Tnevali) TableName() string {
	return "TNEVALI"
}

func (obj *Tnevali) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
