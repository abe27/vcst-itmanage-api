...
type Docdath struct {
	...
	FCDRVTAYLO string `gorm:"column:FCDRVTAYLO;" json:"fcdrvtaylo"  form:"fcdrvtaylo" `
	...
	FCSENDNO   string `gorm:"column:FCSENDNO;" json:"fcsendno"  form:"fcsendno" `
	FCSKID     string `gorm:"primaryKey;column:FCSKID;size:8;unique;index;" json:"fcskid"  form:"fcskid" `
	FCSRCUPD   string `gorm:"column:FCSRCUPD;" json:"fcsrcupd"  form:"fcsrcupd" `
	FCSTARTPLA string `gorm:"column:FCSTARTPLA;" json:"fcstartpla"  form:"fcstartpla" `
	FCTAYLORNO string `gorm:"column:FCTAYLORNO;" json:"fctaylorno"  form:"fctaylorno" `
...
func (Docdath) TableName() string {
	return "DOCDATH"
}

func (obj *Docdath) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
