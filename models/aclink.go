...
type Aclink struct {
	...
	FCCANUSE   string    `gorm:"column:FCCANUSE;" json:"fccanuse"  form:"fccanuse" `
	...
	FCINUSED   string    `gorm:"column:FCINUSED;" json:"fcinused"  form:"fcinused" `
	...
	FCSPEC01   string    `gorm:"column:FCSPEC01;" json:"fcspec01"  form:"fcspec01" `
	FCSPEC02   string    `gorm:"column:FCSPEC02;" json:"fcspec02"  form:"fcspec02" `
	FCSPEC03   string    `gorm:"column:FCSPEC03;" json:"fcspec03"  form:"fcspec03" `
	FCSPEC04   string    `gorm:"column:FCSPEC04;" json:"fcspec04"  form:"fcspec04" `
	FCSPEC05   string    `gorm:"column:FCSPEC05;" json:"fcspec05"  form:"fcspec05" `
	FCSPEC06   string    `gorm:"column:FCSPEC06;" json:"fcspec06"  form:"fcspec06" `
	FCSPEC07   string    `gorm:"column:FCSPEC07;" json:"fcspec07"  form:"fcspec07" `
	FCSPEC08   string    `gorm:"column:FCSPEC08;" json:"fcspec08"  form:"fcspec08" `
	FCSPEC09   string    `gorm:"column:FCSPEC09;" json:"fcspec09"  form:"fcspec09" `
	FCSPEC10   string    `gorm:"column:FCSPEC10;" json:"fcspec10"  form:"fcspec10" `
...
func (Aclink) TableName() string {
	return "ACLINK"
}

func (obj *Aclink) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
