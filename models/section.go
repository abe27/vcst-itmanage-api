...
type Sect struct {
	...
	// FCISMRP    string    `gorm:"column:FCISMRP;" json:"fcismrp"  form:"fcismrp" `
	...
	// FNBRHOL    float64   `gorm:"column:FNBRHOL;" json:"fnbrhol"  form:"fnbrhol" `
...
func (obj *Sect) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(6)
