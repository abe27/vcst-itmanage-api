...
func (Crmconth) TableName() string {
	return "CRMCONTH"
}

func (obj *Crmconth) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
