...
type Laymethd struct {
	...
	FCLAYSTR   string    `gorm:"column:FCLAYSTR;" json:"fclaystr"  form:"fclaystr" `
...
func (Laymethd) TableName() string {
	return "LAYMETHD"
}

func (obj *Laymethd) BeforeCreate(tx *gorm.DB) (err error) {
	id, _ := g.New(8)
	obj.FCSKID = id
	return
}
